...
#> mgs:v5.0.1/load/confirm_load
#
# @within	mgs:v5.0.1/load/valid_dependencies
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"translate":"mgs.loaded_mc_guns_system_v5_0_1","color":"green"}
scoreboard players set #mgs.loaded load.status 1
function mgs:v5.0.1/load/set_items_storage
