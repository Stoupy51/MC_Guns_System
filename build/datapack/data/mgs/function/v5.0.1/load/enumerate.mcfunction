...
execute if score #mgs.major load.status matches 5 if score #mgs.minor load.status matches 0 unless score #mgs.patch load.status matches 1.. run scoreboard players set #mgs.patch load.status 1
