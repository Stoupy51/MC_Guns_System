...
#> mgs:v5.0.1/load/check_dependencies
#
# @within	mgs:v5.0.1/load/secondary
#
...
execute if score #dependency_error mgs.data matches 0 if score $bs.dump.major load.status matches 4 if score $bs.dump.minor load.status matches 0 unless score $bs.dump.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.hitbox.major load.status matches 4 if score $bs.hitbox.minor load.status matches 0 unless score $bs.hitbox.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.id.major load.status matches 4 unless score $bs.id.minor load.status matches 0.. run scoreboard players set #dependency_error mgs.data 1
execute if score #dependency_error mgs.data matches 0 if score $bs.id.major load.status matches 4 if score $bs.id.minor load.status matches 0 unless score $bs.id.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.interaction.major load.status matches 4 if score $bs.interaction.minor load.status matches 0 unless score $bs.interaction.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.math.major load.status matches 4 if score $bs.math.minor load.status matches 0 unless score $bs.math.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.move.major load.status matches 4 if score $bs.move.minor load.status matches 0 unless score $bs.move.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.position.major load.status matches 4 if score $bs.position.minor load.status matches 0 unless score $bs.position.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.random.major load.status matches 4 if score $bs.random.minor load.status matches 0 unless score $bs.random.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.raycast.major load.status matches 4 if score $bs.raycast.minor load.status matches 0 unless score $bs.raycast.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.sidebar.major load.status matches 4 if score $bs.sidebar.minor load.status matches 0 unless score $bs.sidebar.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
...
execute if score #dependency_error mgs.data matches 0 if score $bs.view.major load.status matches 4 if score $bs.view.minor load.status matches 0 unless score $bs.view.patch load.status matches 1.. run scoreboard players set #dependency_error mgs.data 1
