...
#> mgs:v5.0.1/projectile/match_shooter
#
# @executed	as @a
#
# @within	mgs:v5.0.1/projectile/explode [ as @a ]
#			mgs:v5.0.1/projectile/explode [ as @e[tag=mgs.armed] ]
#			mgs:v5.0.1/grenade/detonate_frag [ as @a ]
#			mgs:v5.0.1/grenade/detonate_frag [ as @e[tag=mgs.armed] ]
#
