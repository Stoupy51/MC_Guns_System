...
#> mgs:v5.0.1/projectile/init
#
# @executed	anchored eyes & positioned ^ ^ ^0.69
#
# @within	mgs:v5.0.1/projectile/summon [ anchored eyes & positioned ^ ^ ^0.69 ]
#
...
execute if score #is_ray_gun mgs.data matches 0 run function mgs:v5.0.1/projectile/set_model with entity @s data.config
...
function mgs:v5.0.1/shared/calc_velocity
