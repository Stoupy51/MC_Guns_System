...
#> mgs:v5.0.1/raycast/headshot_and_damage
#
# @executed	as @e[tag=mgs.raycast_target]
#
# @within	mgs:v5.0.1/raycast/on_exit_point [ as @e[tag=mgs.raycast_target] ]
#
...
execute unless score $raycast.entry_point.y bs.lambda matches 1400.. at @s run return run function mgs:v5.0.1/raycast/apply_damage
...
execute at @s run function mgs:v5.0.1/raycast/apply_damage
