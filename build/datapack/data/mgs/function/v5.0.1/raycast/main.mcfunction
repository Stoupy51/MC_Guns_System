...
#> mgs:v5.0.1/raycast/main
#
# @executed	anchored eyes & positioned ^ ^ ^
#
# @within	mgs:v5.0.1/player/shoot [ anchored eyes & positioned ^ ^ ^ ]
#			mgs:v5.0.1/mob/shoot [ anchored eyes & positioned ^ ^ ^ ]
#
...
# Handle accuracy
tp @s ~ ~ ~ ~ ~
function mgs:v5.0.1/raycast/accuracy/apply_spread
...
data modify storage mgs:input with.on_entry_point set value "function mgs:v5.0.1/raycast/on_entry_point"
data modify storage mgs:input with.on_targeted_block set value "function mgs:v5.0.1/raycast/on_targeted_block"
data modify storage mgs:input with.on_targeted_entity set value "function mgs:v5.0.1/raycast/on_targeted_entity"
data modify storage mgs:input with.on_exit_point set value "function mgs:v5.0.1/raycast/on_exit_point"
