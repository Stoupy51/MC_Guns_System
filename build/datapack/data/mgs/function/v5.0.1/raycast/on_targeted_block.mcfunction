...
#> mgs:v5.0.1/raycast/on_targeted_block
#
# @executed	anchored eyes & positioned ^ ^ ^
#
# @within	mgs:v5.0.1/raycast/main
#
...
execute if block ~ ~ ~ #mgs:v5.0.1/sounds/water run scoreboard players set #is_water mgs.data 1
...
execute if score #is_pass_through mgs.data matches 1 unless block ~ ~ ~ #mgs:v5.0.1/sounds/water run return 1
...
execute if score #is_pass_through mgs.data matches 0 if score #hardness mgs.data matches 0.. run function mgs:v5.0.1/raycast/apply_block_hardness
...
execute if block ~ ~ ~ #mgs:v5.0.1/sounds/glass run return run execute if score #played_glass mgs.data matches 0 store success score #played_glass mgs.data run playsound minecraft:block.glass.break block @a[distance=..24] ~ ~ ~ 1
execute if block ~ ~ ~ #mgs:v5.0.1/sounds/cloth run return run execute if score #played_cloth mgs.data matches 0 store success score #played_cloth mgs.data run playsound mgs:common/cloth_bullet_impact block @a[distance=..24] ~ ~ ~ 1
execute if block ~ ~ ~ #mgs:v5.0.1/sounds/dirt run return run execute if score #played_dirt mgs.data matches 0 store success score #played_dirt mgs.data run playsound mgs:common/dirt_bullet_impact block @a[distance=..24] ~ ~ ~ 0.3
execute if block ~ ~ ~ #mgs:v5.0.1/sounds/mud run return run execute if score #played_mud mgs.data matches 0 store success score #played_mud mgs.data run playsound mgs:common/mud_bullet_impact block @a[distance=..24] ~ ~ ~ 0.4
execute if block ~ ~ ~ #mgs:v5.0.1/sounds/wood run return run execute if score #played_wood mgs.data matches 0 store success score #played_wood mgs.data run playsound mgs:common/wood_bullet_impact block @a[distance=..24] ~ ~ ~ 0.5
execute if block ~ ~ ~ #mgs:v5.0.1/plant run return run execute if score #played_plant mgs.data matches 0 store success score #played_plant mgs.data run playsound minecraft:block.azalea_leaves.break block @a[distance=..24] ~ ~ ~ 1
execute if block ~ ~ ~ #mgs:v5.0.1/solid run return run execute if score #played_solid mgs.data matches 0 store success score #played_solid mgs.data run playsound mgs:common/solid_bullet_impact block @a[distance=..24] ~ ~ ~ 0.2
