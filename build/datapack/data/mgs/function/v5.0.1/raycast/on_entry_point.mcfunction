...
#> mgs:v5.0.1/raycast/on_entry_point
#
...
execute if score #is_pass_through mgs.data matches 0 run return run function mgs:v5.0.1/raycast/block_particles with storage mgs:input with
...
execute if score #next_air_particle mgs.data matches 2 run function mgs:v5.0.1/raycast/air_particles with storage mgs:input with
