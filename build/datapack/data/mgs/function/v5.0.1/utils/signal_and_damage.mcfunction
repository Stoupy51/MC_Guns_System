...
#> mgs:v5.0.1/utils/signal_and_damage
#
# @executed	at @s
#
# @within	mgs:v5.0.1/raycast/apply_damage
#			mgs:v5.0.1/projectile/explode [ as @n[tag=...] ]
#			mgs:v5.0.1/projectile/damage_entity
#
...
function mgs:v5.0.1/utils/damage with storage mgs:input with
