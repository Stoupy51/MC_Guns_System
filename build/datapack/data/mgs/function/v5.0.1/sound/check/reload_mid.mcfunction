...
#> mgs:v5.0.1/sound/check/reload_mid
#
...
execute if score @s mgs.cooldown = #half mgs.data run function mgs:v5.0.1/sound/player_mid with storage mgs:gun all.sounds
