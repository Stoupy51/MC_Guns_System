...
#> mgs:v5.0.1/sound/check/reload_end
#
...
execute if score @s mgs.cooldown = #reload_end mgs.data run function mgs:v5.0.1/sound/player_end with storage mgs:gun all.sounds
