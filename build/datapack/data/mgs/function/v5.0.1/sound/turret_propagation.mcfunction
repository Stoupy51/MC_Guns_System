...
#> mgs:v5.0.1/sound/turret_propagation
#
# @executed	as @a[distance=0.001..224] & facing entity @s eyes
#
# @within	mgs:v5.0.1/sound/turret_fire [ as @a[distance=0.001..224] & facing entity @s eyes ]
#
...
execute if score #processed_acoustics mgs.data matches 0 run function mgs:v5.0.1/sound/hearing/0_distant with storage mgs:temp _turret_snd
execute if score #processed_acoustics mgs.data matches 1 run function mgs:v5.0.1/sound/hearing/1_far with storage mgs:temp _turret_snd
execute if score #processed_acoustics mgs.data matches 2 run function mgs:v5.0.1/sound/hearing/2_midrange with storage mgs:temp _turret_snd
execute if score #processed_acoustics mgs.data matches 3 run function mgs:v5.0.1/sound/hearing/3_near with storage mgs:temp _turret_snd
execute if score #processed_acoustics mgs.data matches 4 run function mgs:v5.0.1/sound/hearing/4_closest with storage mgs:temp _turret_snd
execute if score #processed_acoustics mgs.data matches 5 run function mgs:v5.0.1/sound/hearing/5_water with storage mgs:temp _turret_snd
