...
#> mgs:v5.0.1/maps/zombies/kino_der_toten/teleporter/return_one
#
# @executed	as @a[tag=mgs.kino.in_tp]
#
# @within	mgs:v5.0.1/maps/zombies/kino_der_toten/teleporter/return_players [ as @a[tag=mgs.kino.in_tp] ]
#
