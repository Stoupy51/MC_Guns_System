...
execute if score #kino_tp_timer mgs.data matches 1 run playsound minecraft:entity.firework_rocket.twinkle block @a[distance=..30] ~ ~ ~ 1 1
execute if score #kino_tp_timer mgs.data matches 11 run playsound minecraft:entity.firework_rocket.twinkle block @a[distance=..30] ~ ~ ~ 1 1
execute if score #kino_tp_timer mgs.data matches 21 run playsound minecraft:entity.firework_rocket.twinkle block @a[distance=..30] ~ ~ ~ 1 1
