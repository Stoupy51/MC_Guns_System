...
## Meteorites
execute positioned ~-12 ~0 ~-5 run summon interaction ~ ~ ~ {Tags:["mgs.kino","mgs.kino.meteorite_1","bs.entity.interaction"],width:1.1f,height:2.1f}
execute positioned ~-58 ~-2 ~-22 run summon interaction ~ ~ ~ {Tags:["mgs.kino","mgs.kino.meteorite_2","bs.entity.interaction"],width:1.1f,height:2.1f}
execute positioned ~-54 ~4 ~39 run summon interaction ~ ~ ~ {Tags:["mgs.kino","mgs.kino.meteorite_3","bs.entity.interaction"],width:1.1f,height:2.1f}
