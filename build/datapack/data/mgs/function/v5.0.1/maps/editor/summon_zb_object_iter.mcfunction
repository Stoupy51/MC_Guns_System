...
#> mgs:v5.0.1/maps/editor/summon_zb_object_iter
#
# @within	mgs:v5.0.1/maps/editor/summon_existing/zombies
#			mgs:v5.0.1/maps/editor/summon_zb_object_iter
#
...
# Summon marker
function mgs:v5.0.1/maps/editor/summon_zb_marker with storage mgs:temp _zbpos
