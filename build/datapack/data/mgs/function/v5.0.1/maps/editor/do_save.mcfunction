...
#> mgs:v5.0.1/maps/editor/do_save
#
# @within	mgs:v5.0.1/maps/editor/save_exit
...
execute as @n[tag=mgs.element.base_coordinates] at @s run function mgs:v5.0.1/maps/editor/save_base
...
execute if score @s mgs.mp.map_mode matches 0 run function mgs:v5.0.1/maps/editor/save_lists/multiplayer
execute if score @s mgs.mp.map_mode matches 1 run function mgs:v5.0.1/maps/editor/save_lists/zombies
execute if score @s mgs.mp.map_mode matches 2 run function mgs:v5.0.1/maps/editor/save_lists/missions

# Write back to storage
function mgs:v5.0.1/maps/editor/write_back with storage mgs:temp map_edit
