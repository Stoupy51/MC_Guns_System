...
#> mgs:v5.0.1/maps/editor/set_door_link_apply
#
# @executed	at @s & as @n[tag=mgs.map_element,distance=..10]
#
# @within	mgs:v5.0.1/maps/editor/set_door_link_price
#			mgs:v5.0.1/maps/editor/set_door_link_back_group_id
#			mgs:v5.0.1/maps/editor/set_door_link_block
#			mgs:v5.0.1/maps/editor/set_door_link_animation
#			mgs:v5.0.1/maps/editor/set_door_link_sound
#			mgs:v5.0.1/maps/editor/set_door_link_name
#			mgs:v5.0.1/maps/editor/set_door_link_back_name
#
...
execute as @e[tag=mgs.element.door] run function mgs:v5.0.1/maps/editor/door_set_if_match
