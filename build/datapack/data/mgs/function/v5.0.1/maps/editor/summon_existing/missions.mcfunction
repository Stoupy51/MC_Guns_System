...
#
# @within	mgs:v5.0.1/maps/editor/summon_existing
#
...
execute if data storage mgs:temp _spawn_iter[0] run function mgs:v5.0.1/maps/editor/summon_spawn_iter

data modify storage mgs:temp _enemy_edit_iter set from storage mgs:temp map_edit.map.enemies
execute if data storage mgs:temp _enemy_edit_iter[0] run function mgs:v5.0.1/maps/editor/summon_enemy_edit_iter
...
execute if data storage mgs:temp _point_iter[0] run function mgs:v5.0.1/maps/editor/summon_point_iter
...
execute if data storage mgs:temp _start_cmd_iter[0] run function mgs:v5.0.1/maps/editor/summon_start_command_iter
