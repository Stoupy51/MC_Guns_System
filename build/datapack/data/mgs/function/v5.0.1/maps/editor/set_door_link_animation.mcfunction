...
#
# @within	mgs:v5.0.1/maps/editor/show_element_config {animation:0}"}, "hover_event": {"action": "show_text", "value": "Sets animation on ALL doors with same link_id"}}, "\u270e", "]"],"  ",{"text":"ⓘ","color":"aqua","hover_event":{"action":"show_text","value":"Open animation:\n0 = Destroy — block-break particles + sound\n1+ = Silent — blocks instantly replaced with air"}}]
#
# @args		animation (int)
#
