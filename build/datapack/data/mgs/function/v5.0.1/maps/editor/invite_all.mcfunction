...
#> mgs:v5.0.1/maps/editor/invite_all
#
# @within	mgs:v5.0.1/maps/editor/enter "hover_event": {"action": "show_text", "value": "Put all online players into this editor session"}}, "Invite All Players", "]"]]
#
...
execute as @a[scores={mgs.mp.map_edit=1}] run function mgs:v5.0.1/maps/editor/give_tools
...
execute as @a[scores={mgs.mp.map_edit=1}] run function mgs:v5.0.1/shared/tp_to_position with storage mgs:temp _tp
