...
#> mgs:v5.0.1/maps/editor/summon_enemy_edit_iter
#
# @within	mgs:v5.0.1/maps/editor/summon_existing/missions
#			mgs:v5.0.1/maps/editor/summon_enemy_edit_iter
#
...
# Summon marker
function mgs:v5.0.1/maps/editor/summon_enemy_marker with storage mgs:temp _epos
