...
#> mgs:v5.0.1/maps/editor/menu_entry
#
# @within	mgs:v5.0.1/maps/editor/list/multiplayer
...
function mgs:v5.0.1/maps/editor/menu_entry_display with storage mgs:temp map_menu
