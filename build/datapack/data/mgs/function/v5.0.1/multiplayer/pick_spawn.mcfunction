...
#> mgs:v5.0.1/multiplayer/pick_spawn
#
# @executed	at @s
#
# @within	mgs:v5.0.1/multiplayer/tp_all_to_spawns {type:"general"} [ at @s ]
#			mgs:v5.0.1/multiplayer/tp_all_to_spawns {type:"red"} [ at @s ]
#			mgs:v5.0.1/multiplayer/tp_all_to_spawns {type:"blue"} [ at @s ]
...
execute as @e[tag=mgs.spawn_candidate] at @s run function mgs:v5.0.1/multiplayer/spawn_calc_dist
...
execute as @e[tag=mgs.spawn_candidate,sort=random] if score @s mgs.data = #best_dist mgs.data run function mgs:v5.0.1/multiplayer/tp_to_spawn
