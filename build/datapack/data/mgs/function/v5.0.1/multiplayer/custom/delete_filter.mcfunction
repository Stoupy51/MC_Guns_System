...
#> mgs:v5.0.1/multiplayer/custom/delete_filter
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/custom/delete
#			mgs:v5.0.1/multiplayer/custom/delete_filter
#
...
execute if score #del_match mgs.data matches 1 run scoreboard players set #del_removed mgs.data 1
...
execute if data storage mgs:temp _del_src[0] run function mgs:v5.0.1/multiplayer/custom/delete_filter
