...
#> mgs:v5.0.1/multiplayer/custom/toggle_vis_rebuild
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/custom/toggle_visibility
#			mgs:v5.0.1/multiplayer/custom/toggle_vis_rebuild
#
...
execute if score #vis_match mgs.data matches 1 run function mgs:v5.0.1/multiplayer/custom/toggle_entry_vis
...
execute if data storage mgs:temp _del_src[0] run function mgs:v5.0.1/multiplayer/custom/toggle_vis_rebuild
