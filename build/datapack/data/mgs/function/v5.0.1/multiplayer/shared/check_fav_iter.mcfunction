...
#> mgs:v5.0.1/multiplayer/shared/check_fav_iter
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/shared/check_is_fav
#			mgs:v5.0.1/multiplayer/shared/check_fav_iter
#
...
execute unless score #is_fav mgs.data matches 1 if data storage mgs:temp _fav_check[0] run function mgs:v5.0.1/multiplayer/shared/check_fav_iter
