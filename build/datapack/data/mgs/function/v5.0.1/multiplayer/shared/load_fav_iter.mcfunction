...
#> mgs:v5.0.1/multiplayer/shared/load_fav_iter
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/shared/load_player_favorites
#			mgs:v5.0.1/multiplayer/shared/load_fav_iter
#
...
execute unless score #pd_pid mgs.data = @s mgs.mp.pid if data storage mgs:temp _pd_iter[0] run function mgs:v5.0.1/multiplayer/shared/load_fav_iter
