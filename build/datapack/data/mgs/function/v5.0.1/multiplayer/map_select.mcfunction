...
#
# @within	mgs:v5.0.1/multiplayer/setup "hover_event": {"action": "show_text", "value": "Browse and select a map"}}, "Select Map", "]"]]
#

tellraw @s {"text":"============================================","color":"dark_gray"}
tellraw @s [{"text":"","color":"aqua","bold":true},"  🗺 ",{"translate":"mgs.select_map"}]
tellraw @s {"text":"============================================","color":"dark_gray"}
