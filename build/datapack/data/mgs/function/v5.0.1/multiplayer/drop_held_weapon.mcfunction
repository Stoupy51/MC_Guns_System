...
#> mgs:v5.0.1/multiplayer/drop_held_weapon
#
# @executed	at @s
#
# @within	mgs:v5.0.1/multiplayer/enter_death_spectate [ at @s ]
#
...
scoreboard players set @n[tag=mgs.mp_drop_new] mgs.mp.drop_timer 600
execute as @n[tag=mgs.mp_drop_new] run function #bs.interaction:on_right_click {run:"function mgs:v5.0.1/multiplayer/pickup_dropped_weapon",executor:"source"}
tag @n[tag=mgs.mp_drop_new] remove mgs.mp_drop_new
