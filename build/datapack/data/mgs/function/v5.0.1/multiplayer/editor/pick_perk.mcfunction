...
function mgs:v5.0.1/multiplayer/editor/toggle_perk with storage mgs:temp
...
execute if data storage mgs:temp {_toggle_perk:"overkill"} run function mgs:v5.0.1/multiplayer/editor/clear_secondary
