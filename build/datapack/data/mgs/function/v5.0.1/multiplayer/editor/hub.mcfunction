...
#> mgs:v5.0.1/multiplayer/editor/hub
#
...
#			mgs:v5.0.1/multiplayer/editor/pick_overkill_secondary
#			mgs:v5.0.1/multiplayer/editor/remove_primary
#			mgs:v5.0.1/multiplayer/editor/remove_secondary
...
#			mgs:v5.0.1/multiplayer/editor/show_primary_mags_dialog
#			mgs:v5.0.1/multiplayer/editor/show_secondary_mags_dialog
...
#			mgs:v5.0.1/multiplayer/editor/save
...
function mgs:v5.0.1/multiplayer/editor/hub_base with storage mgs:temp _hub
function mgs:v5.0.1/multiplayer/editor/hub_row_primary with storage mgs:temp editor
...
execute unless data storage mgs:temp editor{primary:""} run function mgs:v5.0.1/multiplayer/editor/hub_row_primary_mags with storage mgs:temp editor
function mgs:v5.0.1/multiplayer/editor/hub_row_secondary with storage mgs:temp editor
...
execute unless data storage mgs:temp editor{secondary:""} run function mgs:v5.0.1/multiplayer/editor/hub_row_secondary_mags with storage mgs:temp editor
function mgs:v5.0.1/multiplayer/editor/hub_row_equip1 with storage mgs:temp editor
function mgs:v5.0.1/multiplayer/editor/hub_row_equip2 with storage mgs:temp editor
function mgs:v5.0.1/multiplayer/editor/hub_row_perks with storage mgs:temp _hub
