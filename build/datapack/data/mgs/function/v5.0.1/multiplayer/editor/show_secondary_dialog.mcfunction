...
#
# @within	mgs:v5.0.1/multiplayer/editor/pick_primary_mags
#			mgs:v5.0.1/multiplayer/editor/back_to_secondary
#
...
function mgs:v5.0.1/multiplayer/editor/show_secondary_dialog_macro with storage mgs:temp
