...
#> mgs:v5.0.1/multiplayer/editor/show_confirm
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/editor/perks_done with storage mgs:temp editor
#
...
function mgs:v5.0.1/multiplayer/editor/patch_pts_used with storage mgs:temp

# Append perk lines to body
execute if data storage mgs:temp editor.perks[0] run function mgs:v5.0.1/multiplayer/editor/append_perks_to_confirm
