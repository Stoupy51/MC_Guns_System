...
#> mgs:v5.0.1/multiplayer/editor/rebuild_perks
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/editor/remove_perk with storage mgs:temp
#			mgs:v5.0.1/multiplayer/editor/rebuild_perks with storage mgs:temp
#
...
function mgs:v5.0.1/multiplayer/editor/rebuild_perks with storage mgs:temp
