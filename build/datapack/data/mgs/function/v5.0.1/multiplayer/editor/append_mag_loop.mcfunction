...
#> mgs:v5.0.1/multiplayer/editor/append_mag_loop
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/editor/append_mag_slots
#			mgs:v5.0.1/multiplayer/editor/append_mag_loop
#
...
function mgs:v5.0.1/multiplayer/editor/append_mag_regular with storage mgs:temp
scoreboard players add #inv_slot mgs.data 1
scoreboard players remove #pmag_count mgs.data 1
return run function mgs:v5.0.1/multiplayer/editor/append_mag_loop
