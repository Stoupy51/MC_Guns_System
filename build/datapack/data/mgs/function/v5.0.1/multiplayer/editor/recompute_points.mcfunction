...
#> mgs:v5.0.1/multiplayer/editor/recompute_points
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/editor/commit_check
#			mgs:v5.0.1/multiplayer/editor/hub
#			mgs:v5.0.1/multiplayer/editor/show_primary_dialog
#			mgs:v5.0.1/multiplayer/editor/show_secondary_pistol_dialog
#			mgs:v5.0.1/multiplayer/editor/show_secondary_overkill_dialog
#			mgs:v5.0.1/multiplayer/editor/show_scope_primary_full
#			mgs:v5.0.1/multiplayer/editor/show_scope_primary_no4
#			mgs:v5.0.1/multiplayer/editor/show_scope_primary_1only
#			mgs:v5.0.1/multiplayer/editor/show_scope_secondary_4only
#			mgs:v5.0.1/multiplayer/editor/show_primary_camo_dialog
#			mgs:v5.0.1/multiplayer/editor/show_secondary_camo_dialog
#			mgs:v5.0.1/multiplayer/editor/show_equip1_camo_dialog
#			mgs:v5.0.1/multiplayer/editor/show_equip2_camo_dialog
#			mgs:v5.0.1/multiplayer/editor/show_primary_mags_dialog
#			mgs:v5.0.1/multiplayer/editor/show_secondary_mags_dialog
#			mgs:v5.0.1/multiplayer/editor/show_equip_slot1_dialog
#			mgs:v5.0.1/multiplayer/editor/show_equip_slot2_dialog
#			mgs:v5.0.1/multiplayer/editor/show_perks_dialog
