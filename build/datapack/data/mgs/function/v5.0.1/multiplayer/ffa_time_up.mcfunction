...
#> mgs:v5.0.1/multiplayer/ffa_time_up
#
# @within	mgs:v5.0.1/multiplayer/time_up
#
...
execute as @a[scores={mgs.mp.in_game=1}] if score @s mgs.mp.kills = #max_kills mgs.data run function mgs:v5.0.1/multiplayer/gamemodes/ffa/player_wins
