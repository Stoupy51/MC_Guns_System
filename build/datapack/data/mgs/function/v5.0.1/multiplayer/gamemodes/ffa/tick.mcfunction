...
#> mgs:v5.0.1/multiplayer/gamemodes/ffa/tick
#
...
execute as @a if score @s mgs.mp.kills >= #score_limit mgs.data run function mgs:v5.0.1/multiplayer/gamemodes/ffa/player_wins
