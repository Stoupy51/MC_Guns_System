...
#> mgs:v5.0.1/multiplayer/gamemodes/dom/capture_red
#
# @executed	at @s
#
# @within	mgs:v5.0.1/multiplayer/gamemodes/dom/point_tick
#
...
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_A] run tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_a","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_B] run tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_b","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_C] run tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_c","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_D] run tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_d","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_E] run tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_e","color":"yellow"}]
