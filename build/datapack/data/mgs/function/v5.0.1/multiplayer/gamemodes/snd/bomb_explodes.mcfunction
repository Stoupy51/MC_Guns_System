...
#> mgs:v5.0.1/multiplayer/gamemodes/snd/bomb_explodes
#
# @within	mgs:v5.0.1/multiplayer/gamemodes/snd/tick
#
...
execute at @e[tag=mgs.snd_bomb] as @a[distance=..10,gamemode=!creative,gamemode=!spectator,scores={mgs.mp.in_game=1..}] run function mgs:v5.0.1/multiplayer/simulate_death

tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],[{"text":"💥 ","color":"red","bold":true}, {"translate":"mgs.bomb_exploded"}]]
kill @e[tag=mgs.snd_bomb]
function mgs:v5.0.1/multiplayer/gamemodes/snd/attackers_win
