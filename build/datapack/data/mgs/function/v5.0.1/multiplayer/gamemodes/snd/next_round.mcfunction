...
execute if score #snd_red_wins mgs.data >= #snd_win_threshold mgs.data run function mgs:v5.0.1/multiplayer/team_wins {team:"Red"}
execute if score #snd_blue_wins mgs.data >= #snd_win_threshold mgs.data run function mgs:v5.0.1/multiplayer/team_wins {team:"Blue"}
