...
#> mgs:v5.0.1/multiplayer/gamemodes/dom/point_tick
#
# @executed	at @s
#
# @within	mgs:v5.0.1/multiplayer/gamemodes/dom/tick [ at @s ]
#
...
execute if score #dom_red mgs.data matches 1.. unless score #dom_blue mgs.data matches 1.. run function mgs:v5.0.1/multiplayer/gamemodes/dom/capture_red

# If only blue present: progress toward blue (decrease toward -100)
execute if score #dom_blue mgs.data matches 1.. unless score #dom_red mgs.data matches 1.. run function mgs:v5.0.1/multiplayer/gamemodes/dom/capture_blue
