...
#> mgs:v5.0.1/multiplayer/gamemodes/dom/summon_point
#
# @within	mgs:v5.0.1/multiplayer/gamemodes/dom/setup
#			mgs:v5.0.1/multiplayer/gamemodes/dom/summon_point
#
...
function mgs:v5.0.1/multiplayer/gamemodes/dom/summon_point_at with storage mgs:temp _dom_pos

# Advance
data remove storage mgs:temp _dom_iter[0]
execute if data storage mgs:temp _dom_iter[0] run function mgs:v5.0.1/multiplayer/gamemodes/dom/summon_point
