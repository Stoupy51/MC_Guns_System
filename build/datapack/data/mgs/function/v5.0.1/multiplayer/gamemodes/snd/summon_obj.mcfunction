...
#> mgs:v5.0.1/multiplayer/gamemodes/snd/summon_obj
#
...
function mgs:v5.0.1/multiplayer/gamemodes/snd/summon_obj_at with storage mgs:temp _snd_pos
data remove storage mgs:temp _snd_iter[0]
execute if data storage mgs:temp _snd_iter[0] run function mgs:v5.0.1/multiplayer/gamemodes/snd/summon_obj
