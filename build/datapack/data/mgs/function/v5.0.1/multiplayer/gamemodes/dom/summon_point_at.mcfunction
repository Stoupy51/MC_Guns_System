...
#> mgs:v5.0.1/multiplayer/gamemodes/dom/summon_point_at
#
# @within	mgs:v5.0.1/multiplayer/gamemodes/dom/summon_point with storage mgs:temp _dom_pos
#
# @args		x (unknown)
#			y (unknown)
#			z (unknown)
...
$summon minecraft:marker $(x) $(y) $(z) {Tags:["mgs.dom_point","mgs.gm_entity","mgs.dom_label_$(label)"]}
