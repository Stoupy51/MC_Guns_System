...
#> mgs:v5.0.1/multiplayer/gamemodes/hp/tick
#
...
execute if score #hp_rotate_timer mgs.data matches ..0 run function mgs:v5.0.1/multiplayer/gamemodes/hp/rotate
...
execute if score #hp_score_timer mgs.data matches ..0 run function mgs:v5.0.1/multiplayer/gamemodes/hp/score_tick
