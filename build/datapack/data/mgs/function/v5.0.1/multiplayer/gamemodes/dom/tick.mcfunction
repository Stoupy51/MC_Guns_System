...
#> mgs:v5.0.1/multiplayer/gamemodes/dom/tick
#
# @within	mgs:v5.0.1/multiplayer/game_tick
#

# Process each domination point
execute as @e[tag=mgs.dom_point] at @s run function mgs:v5.0.1/multiplayer/gamemodes/dom/point_tick
...
execute if score #dom_score_timer mgs.data matches ..0 run function mgs:v5.0.1/multiplayer/gamemodes/dom/score_tick
...
execute as @e[tag=mgs.dom_point] at @s run function mgs:v5.0.1/multiplayer/gamemodes/dom/point_particles
