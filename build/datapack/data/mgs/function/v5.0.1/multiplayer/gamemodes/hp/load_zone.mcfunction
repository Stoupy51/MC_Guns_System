...
#> mgs:v5.0.1/multiplayer/gamemodes/hp/load_zone
#
# @within	mgs:v5.0.1/multiplayer/gamemodes/hp/setup
...
function mgs:v5.0.1/multiplayer/gamemodes/hp/summon_marker with storage mgs:temp _hp_pos
