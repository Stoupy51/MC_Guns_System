...
#> mgs:v5.0.1/multiplayer/select_class
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/player/tick
#			mgs:v5.0.1/player/config/process
#			mgs:v5.0.1/zombies/join_game
#			mgs:v5.0.1/multiplayer/start [ as @a[scores={mgs.mp.in_game=1}] ]
...
#			mgs:v5.0.1/missions/preload_complete [ as @a[scores={mgs.mi.in_game=1}] ]
