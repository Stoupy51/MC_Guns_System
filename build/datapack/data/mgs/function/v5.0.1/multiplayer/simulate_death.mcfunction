...
execute if data storage mgs:input with.attacker run function mgs:v5.0.1/multiplayer/simulate_death_fire_kill with storage mgs:input with

# No attacker: random funny self-death message
execute unless data storage mgs:input with.attacker run function mgs:v5.0.1/multiplayer/random_death_message
