...
#			mgs:v5.0.1/multiplayer/editor/scope/primary_full_macro with storage mgs:temp
#			mgs:v5.0.1/multiplayer/editor/scope/primary_no4_macro with storage mgs:temp
#			mgs:v5.0.1/multiplayer/editor/scope/primary_1only_macro with storage mgs:temp
...
#			mgs:v5.0.1/multiplayer/editor/show_perks_dialog_macro with storage mgs:temp
#			mgs:v5.0.1/multiplayer/editor/show_confirm with storage mgs:temp
