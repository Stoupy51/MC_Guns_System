...
execute if score #mp_has_boundary mgs.data matches 1 run function mgs:v5.0.1/multiplayer/check_bounds
...
execute if entity @s[gamemode=!spectator] if entity @e[tag=mgs.oob_point,distance=..5] run function mgs:v5.0.1/multiplayer/bounds_kill
