...
#
# @within	mgs:v5.0.1/multiplayer/marketplace/browse_likes
#			mgs:v5.0.1/multiplayer/marketplace/sort_build_list
#
...
execute if data storage mgs:temp _find_max_iter[0] run function mgs:v5.0.1/multiplayer/marketplace/sort_find_max
...
function mgs:v5.0.1/multiplayer/marketplace/prep_btn
...
execute if data storage mgs:temp _pool_rebuild[0] run function mgs:v5.0.1/multiplayer/marketplace/sort_remove_best

# Recurse if pool still has entries
execute if data storage mgs:temp _sort_pool[0] run function mgs:v5.0.1/multiplayer/marketplace/sort_build_list
