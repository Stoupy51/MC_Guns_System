...
#> mgs:v5.0.1/multiplayer/marketplace/browse
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/player/config/process
#			mgs:v5.0.1/multiplayer/custom/toggle_favorite
#			mgs:v5.0.1/multiplayer/custom/like
#
...
data modify storage mgs:temp _iter set from storage mgs:multiplayer custom_loadouts
execute if data storage mgs:temp _iter[0] run function mgs:v5.0.1/multiplayer/marketplace/build_list_rest
