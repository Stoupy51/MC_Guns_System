...
#> mgs:v5.0.1/multiplayer/apply_class
#
# @within	mgs:v5.0.1/zombies/join_game
#			mgs:v5.0.1/multiplayer/start [ at @s ]
#			mgs:v5.0.1/multiplayer/join_game
#			mgs:v5.0.1/multiplayer/prep_tick [ at @s ]
#			mgs:v5.0.1/multiplayer/gamemodes/snd/start_round [ as @a[scores={mgs.mp.team=1..2}] & at @s ]
#			mgs:v5.0.1/multiplayer/set_class
#			mgs:v5.0.1/multiplayer/actual_respawn
#			mgs:v5.0.1/multiplayer/auto_apply_default
#			mgs:v5.0.1/multiplayer/custom/notify_selected
#			mgs:v5.0.1/missions/preload_complete [ at @s ]
#			mgs:v5.0.1/missions/prep_tick [ at @s ]
...
execute if score @s mgs.mp.class matches ..-1 run return run function mgs:v5.0.1/multiplayer/apply_custom_class
