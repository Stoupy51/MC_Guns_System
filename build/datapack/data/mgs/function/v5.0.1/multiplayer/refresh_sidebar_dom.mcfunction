...
#> mgs:v5.0.1/multiplayer/refresh_sidebar_dom
#
# @within	mgs:v5.0.1/multiplayer/create_sidebar_dom
#			mgs:v5.0.1/multiplayer/gamemodes/dom/score_tick
#			mgs:v5.0.1/multiplayer/gamemodes/dom/on_kill
#
...
function mgs:v5.0.1/multiplayer/build_sidebar_dom with storage mgs:temp dom_sb
