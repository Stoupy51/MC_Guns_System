...
#> mgs:v5.0.1/multiplayer/my_loadouts/manage_prep
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/my_loadouts/manage_find
#
...
execute if score #pub mgs.data matches 1 run function mgs:v5.0.1/multiplayer/my_loadouts/manage_build_public with storage mgs:temp _btn_data
execute if score #pub mgs.data matches 0 run function mgs:v5.0.1/multiplayer/my_loadouts/manage_build_private with storage mgs:temp _btn_data
