...
#> mgs:v5.0.1/multiplayer/my_loadouts/prep_btn
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/my_loadouts/build_list_favs
#			mgs:v5.0.1/multiplayer/my_loadouts/check_private_not_fav
#			mgs:v5.0.1/multiplayer/my_loadouts/check_public_not_fav
#
...
execute if score #pub mgs.data matches 1 run function mgs:v5.0.1/multiplayer/my_loadouts/add_btn_public with storage mgs:temp _btn_data
execute if score #pub mgs.data matches 0 run function mgs:v5.0.1/multiplayer/my_loadouts/add_btn_private with storage mgs:temp _btn_data
