...
#> mgs:v5.0.1/multiplayer/my_loadouts/browse
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/player/config/process
#			mgs:v5.0.1/multiplayer/editor/save
#			mgs:v5.0.1/multiplayer/custom/delete
#			mgs:v5.0.1/multiplayer/custom/toggle_visibility
#
...
function mgs:v5.0.1/multiplayer/shared/load_player_favorites
...
execute if data storage mgs:temp _iter[0] run function mgs:v5.0.1/multiplayer/my_loadouts/build_list_favs

# Pass 2: Own private loadouts NOT in favorites
data modify storage mgs:temp _iter set from storage mgs:multiplayer custom_loadouts
execute if data storage mgs:temp _iter[0] run function mgs:v5.0.1/multiplayer/my_loadouts/build_list_privates

# Pass 3: Own public loadouts NOT in favorites
data modify storage mgs:temp _iter set from storage mgs:multiplayer custom_loadouts
execute if data storage mgs:temp _iter[0] run function mgs:v5.0.1/multiplayer/my_loadouts/build_list_publics
