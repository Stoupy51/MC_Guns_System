...
#> mgs:v5.0.1/multiplayer/my_loadouts/manage_build_private
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/multiplayer/my_loadouts/manage_prep with storage mgs:temp _btn_data
#
# @args		name (unknown)
