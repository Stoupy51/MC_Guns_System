...
#> mgs:v5.0.1/multiplayer/refresh_sidebar_ffa
#
# @within	mgs:v5.0.1/multiplayer/timer_display
#			mgs:v5.0.1/multiplayer/create_sidebar_ffa
#			mgs:v5.0.1/multiplayer/gamemodes/ffa/on_kill
#
...
# Rank 1
execute unless entity @a[tag=mgs.ffa_candidate] run return run function mgs:v5.0.1/multiplayer/build_sidebar_ffa with storage mgs:temp
...
# Build
function mgs:v5.0.1/multiplayer/build_sidebar_ffa with storage mgs:temp
