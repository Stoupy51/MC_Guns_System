...
#> mgs:v5.0.1/missions/summon_spawn_iter
#
# @within	mgs:v5.0.1/missions/summon_spawns
#			mgs:v5.0.1/missions/summon_spawn_iter
#
...
function mgs:v5.0.1/missions/summon_spawn_at with storage mgs:temp _spos

data remove storage mgs:temp _spawn_iter[0]
execute if data storage mgs:temp _spawn_iter[0] run function mgs:v5.0.1/missions/summon_spawn_iter
