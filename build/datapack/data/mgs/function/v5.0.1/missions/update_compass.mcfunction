...
#> mgs:v5.0.1/missions/update_compass
#
# @executed	at @s
#
# @within	mgs:v5.0.1/missions/game_tick [ at @s ]
#
...
function mgs:v5.0.1/missions/set_compass_target with storage mgs:temp _compass
