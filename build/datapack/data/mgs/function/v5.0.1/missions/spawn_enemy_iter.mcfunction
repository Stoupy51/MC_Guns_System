...
#> mgs:v5.0.1/missions/spawn_enemy_iter
#
# @within	mgs:v5.0.1/missions/spawn_all_enemies
#			mgs:v5.0.1/missions/spawn_enemy_iter
#
...
function mgs:v5.0.1/missions/call_enemy_function with storage mgs:temp _epos

# Next
data remove storage mgs:temp _enemy_iter[0]
execute if data storage mgs:temp _enemy_iter[0] run function mgs:v5.0.1/missions/spawn_enemy_iter
