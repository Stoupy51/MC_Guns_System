...
#> mgs:v5.0.1/missions/preload_complete
#
# @within	mgs:v5.0.1/missions/start 20t [ scheduled ]
#
...
# Summon OOB markers
function mgs:v5.0.1/shared/summon_oob {mode:"missions"}

# Summon spawn point markers
function mgs:v5.0.1/missions/summon_spawns

# Signal mission start
function #mgs:missions/on_mission_start

# Teleport all players to mission spawns
function mgs:v5.0.1/missions/tp_all_to_spawns
...
execute as @a[scores={mgs.mi.in_game=1}] run function mgs:v5.0.1/multiplayer/select_class
...
schedule function mgs:v5.0.1/missions/end_prep 180t
