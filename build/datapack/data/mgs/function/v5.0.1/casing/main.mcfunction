...
execute anchored eyes positioned ^ ^ ^ summon marker run function mgs:v5.0.1/casing/process_vectors
...
execute as @n[type=item,tag=mgs.new] run function mgs:v5.0.1/casing/update_item
