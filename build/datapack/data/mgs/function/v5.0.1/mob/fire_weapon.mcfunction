...
#> mgs:v5.0.1/mob/fire_weapon
#
# @executed	anchored eyes & facing entity @n[tag=mgs.target] feet
#
# @within	mgs:v5.0.1/mob/tick [ anchored eyes & facing entity @n[tag=mgs.target] feet ]
#
...
execute unless entity @s[tag=mgs.mob_lv5] run function mgs:v5.0.1/mob/apply_inaccuracy
...
function mgs:v5.0.1/mob/shoot

# Play fire sound to nearby players
execute if data storage mgs:gun all.sounds.fire run function mgs:v5.0.1/mob/fire_sound with storage mgs:gun all.sounds
