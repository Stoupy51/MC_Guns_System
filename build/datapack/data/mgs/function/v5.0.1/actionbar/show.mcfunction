...
function mgs:v5.0.1/actionbar/build_fire_mode_indicator

# Add cooldown ready indicator
function mgs:v5.0.1/actionbar/add_cooldown_indicator
...
execute if score #capacity mgs.data matches 16.. run function mgs:v5.0.1/actionbar/add_numeric_ammo
execute if score #capacity mgs.data matches ..15 run function mgs:v5.0.1/actionbar/add_icon_ammo

# Add DPS display
function mgs:v5.0.1/actionbar/add_dps

# Display actionbar
function mgs:v5.0.1/actionbar/display with storage mgs:temp actionbar
