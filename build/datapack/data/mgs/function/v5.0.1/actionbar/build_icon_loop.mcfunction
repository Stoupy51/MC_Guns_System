...
#> mgs:v5.0.1/actionbar/build_icon_loop
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/actionbar/add_icon_ammo
#			mgs:v5.0.1/actionbar/build_icon_loop
#
...
# Recurse if not done
execute if score #i mgs.data < #capacity mgs.data run function mgs:v5.0.1/actionbar/build_icon_loop
