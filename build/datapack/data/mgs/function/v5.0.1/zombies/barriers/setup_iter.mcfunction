...
#> mgs:v5.0.1/zombies/barriers/setup_iter
#
# @within	mgs:v5.0.1/zombies/barriers/setup
#			mgs:v5.0.1/zombies/barriers/setup_iter
#
...
function mgs:v5.0.1/zombies/barriers/place_at with storage mgs:temp _bplace
...
execute if data storage mgs:temp _barrier_iter[0] run function mgs:v5.0.1/zombies/barriers/setup_iter
