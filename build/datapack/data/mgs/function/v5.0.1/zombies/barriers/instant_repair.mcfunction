...
#> mgs:v5.0.1/zombies/barriers/instant_repair
#
# @executed	as @e[tag=mgs.barrier_display,scores={mgs.zb.barrier.state=1}] & at @s
#
# @within	mgs:v5.0.1/zombies/barriers/repair_all [ as @e[tag=mgs.barrier_display,scores={mgs.zb.barrier.state=1}] & at @s ]
#
