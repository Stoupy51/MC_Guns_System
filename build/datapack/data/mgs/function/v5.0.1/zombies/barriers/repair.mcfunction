...
#> mgs:v5.0.1/zombies/barriers/repair
#
# @executed	as @e[tag=mgs.barrier_display] & at @s
#
# @within	mgs:v5.0.1/zombies/barriers/handle_repair
#
...
execute as @a[tag=mgs.barrier_repairing] if score @s mgs.zb.barrier.repairing_id = #barrier_id mgs.data run function mgs:v5.0.1/zombies/barriers/on_repair_complete_player
