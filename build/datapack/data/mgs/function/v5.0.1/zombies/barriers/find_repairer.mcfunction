...
#> mgs:v5.0.1/zombies/barriers/find_repairer
#
...
$execute as @a[scores={mgs.zb.in_game=1},predicate=mgs:v5.0.1/is_sneaking,distance=..$(radius),tag=!mgs.barrier_repairing,limit=1,sort=nearest] run function mgs:v5.0.1/zombies/barriers/start_repairing_player
