...
#> mgs:v5.0.1/zombies/barriers/tick
#
...
execute if score @s mgs.zb.barrier.state matches 0 positioned ^ ^ ^-1 run function mgs:v5.0.1/zombies/barriers/intact_tick
execute if score @s mgs.zb.barrier.state matches 1 run function mgs:v5.0.1/zombies/barriers/destroyed_tick
