...
#> mgs:v5.0.1/zombies/pap/retreat_cleanup
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/pap/anim/retreat_finish with storage mgs:temp _pap_retreat
#
# @args		id (unknown)
#
...
execute as @a[scores={mgs.zb.pap_s=1..}] if score @s mgs.zb.pap_mid = #pap_mid mgs.data run function mgs:v5.0.1/zombies/pap/retreat_clear_owner
