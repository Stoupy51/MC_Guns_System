...
#> mgs:v5.0.1/zombies/pap/annotate_fire_rate_line
#
...
execute unless score #pap_delta mgs.data matches 0 run function mgs:v5.0.1/zombies/pap/annotate_rate_delta
