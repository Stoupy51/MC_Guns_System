...
#> mgs:v5.0.1/zombies/pap/anim/collect_give
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/pap/anim/collect_lookup with storage mgs:temp _pap_cg
#
# @args		slot (unknown)
#			id (unknown)
#
...
# Refresh ammo HUD
execute as @p[tag=mgs.pap_owner] run function mgs:v5.0.1/ammo/compute_reserve
...
# Notify the player
execute as @p[tag=mgs.pap_owner] run function mgs:v5.0.1/zombies/feedback/sound_success
