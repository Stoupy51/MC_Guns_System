...
#> mgs:v5.0.1/zombies/pap/anim/start
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/pap/repap_scope_only with storage mgs:temp _pap [ at @s ]
#			mgs:v5.0.1/zombies/pap/on_right_click with storage mgs:temp _pap [ at @s ]
#
# @args		slot (unknown)
#
...
execute positioned ~ ~-2 ~ positioned ~ ~0.8 ~ run summon minecraft:item_display ^ ^ ^0.6 {Tags:["mgs.pap_weapon_display","mgs.gm_entity"],billboard:"fixed",item_display:"fixed",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.6f,0.6f,0.6f]}}
...
function mgs:v5.0.1/zombies/pap/anim/store_slot with storage mgs:temp _pap_anim_slot

# Start animation timer: 300 ticks total
scoreboard players set @s mgs.pap_anim 300

# Sound: machine accepting weapon
function mgs:v5.0.1/zombies/feedback/sound_pap_knuckle_crack
function mgs:v5.0.1/zombies/feedback/sound_pap_jingle_sting
