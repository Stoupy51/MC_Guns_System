...
#> mgs:v5.0.1/zombies/pap/pap_chat_message
#
...
tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.machine","color":"gray"},{"storage":"mgs:temp","nbt":"_pap_machine.name","color":"gold","italic":false,"interpret":true},[{"text":"\n","color":"gray"}, {"translate":"mgs.level_2"}],{"score":{"name":"#pap_next","objective":"mgs.data"},"color":"aqua"},{"text":"/","color":"dark_gray"},{"score":{"name":"#pap_max","objective":"mgs.data"},"color":"aqua"},[{"text":"  ","color":"gray"}, {"translate":"mgs.cost"}, ": -"],{"score":{"name":"#pap_price","objective":"mgs.data"},"color":"yellow"},[{"text":" ","color":"gray"}, {"translate":"mgs.points_2"}]]
...
execute if score #pap_li mgs.data < #pap_lore_len mgs.data run function mgs:v5.0.1/zombies/pap/pap_chat_lore_loop
