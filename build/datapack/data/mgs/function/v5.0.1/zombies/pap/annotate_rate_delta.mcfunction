...
#> mgs:v5.0.1/zombies/pap/annotate_rate_delta
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.0.1/zombies/pap/annotate_fire_rate_line
#
...
function mgs:v5.0.1/zombies/pap/annotate_append_dec with storage mgs:temp _pap_ann
