...
#> mgs:v5.0.1/zombies/pap/on_hover
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.0.1/zombies/pap/setup_iter {run:"function mgs:v5.0.1/zombies/pap/on_hover",executor:"source"} [ as @n[tag=mgs.pap_new] ]
#
