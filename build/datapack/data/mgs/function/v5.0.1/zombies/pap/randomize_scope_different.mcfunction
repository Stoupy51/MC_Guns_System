...
#> mgs:v5.0.1/zombies/pap/randomize_scope_different
#
# @within	mgs:v5.0.1/zombies/pap/randomize_scope_different
#			mgs:v5.0.1/zombies/pap/repap_scope_only with storage mgs:temp _pap_extract.stats
...
execute if score #pap_scope_changed mgs.data matches 0 run function mgs:v5.0.1/zombies/pap/randomize_scope_different
