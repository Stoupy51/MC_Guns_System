...
#> mgs:v5.0.1/zombies/pap/annotate_int_delta
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.0.1/zombies/pap/annotate_lore
#			mgs:v5.0.1/zombies/pap/annotate_pellets_line
#
...
function mgs:v5.0.1/zombies/pap/annotate_append_int with storage mgs:temp _pap_ann
