...
#
# @within	mgs:v5.0.1/zombies/powerups/activate/free_pap [ as @p[tag=mgs.pu_collecting] ]
#
...
execute if score #pap_next mgs.data > #pap_max mgs.data run return run function mgs:v5.0.1/zombies/pap/free_scope_reroll with storage mgs:temp _pap
