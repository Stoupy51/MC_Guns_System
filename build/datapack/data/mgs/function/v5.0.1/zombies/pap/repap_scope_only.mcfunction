...
#> mgs:v5.0.1/zombies/pap/repap_scope_only
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.0.1/zombies/pap/on_right_click with storage mgs:temp _pap
#
# @args		slot (unknown)
#

# Guard: enough points for scope/camo re-roll
execute unless score @s mgs.zb.points matches 1000.. run return run function mgs:v5.0.1/zombies/pap/deny_not_enough_points_scope
...
function mgs:v5.0.1/zombies/pap/randomize_scope_different with storage mgs:temp _pap_extract.stats
...
$item modify entity @s $(slot) mgs:v5.0.1/zb_pap_apply_stats
