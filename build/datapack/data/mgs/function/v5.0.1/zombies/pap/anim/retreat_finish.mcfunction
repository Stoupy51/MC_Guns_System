...
#> mgs:v5.0.1/zombies/pap/anim/retreat_finish
#
# @executed	at @s
#
...
function mgs:v5.0.1/zombies/feedback/sound_pap_deny
...
function mgs:v5.0.1/zombies/pap/retreat_cleanup with storage mgs:temp _pap_retreat
