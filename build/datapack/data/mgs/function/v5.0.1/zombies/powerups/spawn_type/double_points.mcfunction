...
$summon minecraft:item_display $(x) $(y) $(z) {Tags:["mgs.pu_item","mgs.pu_item_new","mgs.gm_entity"],item:{id:"minecraft:gold_ingot",count:1},billboard:"vertical",item_display:"ground",brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.25f,0f],scale:[1.5f,1.5f,1.5f]}}
