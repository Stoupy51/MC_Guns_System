...
$summon minecraft:item $(x) $(y) $(z) {Tags:["mgs.pu_item","mgs.pu_item_new","mgs.gm_entity"],PickupDelay:32767,Invulnerable:1b,Item:{id:"minecraft:glass_bottle",count:1,components:{"minecraft:custom_data":{mgs:{powerup_uid:$(uid)}}}}}
