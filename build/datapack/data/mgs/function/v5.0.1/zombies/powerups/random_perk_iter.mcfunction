...
#
# @within	mgs:v5.0.1/zombies/powerups/activate/random_perk
#			mgs:v5.0.1/zombies/powerups/random_perk_iter
#
...
execute if score #pu_perk_roll mgs.data matches 0 run function mgs:v5.0.1/zombies/powerups/try_perk/juggernog
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 1 run function mgs:v5.0.1/zombies/powerups/try_perk/speed_cola
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 2 run function mgs:v5.0.1/zombies/powerups/try_perk/double_tap
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 3 run function mgs:v5.0.1/zombies/powerups/try_perk/quick_revive
execute if score #pu_perk_applied mgs.data matches 1 run return 0
