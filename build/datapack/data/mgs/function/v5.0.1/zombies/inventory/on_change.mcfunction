...
#> mgs:v5.0.1/zombies/inventory/on_change
#
# @executed	as the player & at current position
#
# @within	advancement mgs:v5.0.1/zombies/inventory_changed
#

advancement revoke @s only mgs:v5.0.1/zombies/inventory_changed
...
function mgs:v5.0.1/zombies/inventory/check_slots
