...
#> mgs:v5.0.1/zombies/inventory/apply_slot_tag
#
# @executed	at @s
#
...
#			mgs:v5.0.1/zombies/wallbuys/give_to_slot {slot:"inventory.$(inventory)",group:"inventory",index:$(inventory)}
#			mgs:v5.0.1/zombies/wallbuys/reload_pair {slot:"hotbar.$(hotbar)",group:"hotbar",index:$(hotbar)}
#			mgs:v5.0.1/zombies/wallbuys/reload_pair {slot:"inventory.$(inventory)",group:"inventory",index:$(inventory)}
#			mgs:v5.0.1/zombies/wallbuys/replace_pair {slot:"hotbar.$(hotbar)",group:"hotbar",index:$(hotbar)}
#			mgs:v5.0.1/zombies/wallbuys/replace_pair {slot:"inventory.$(inventory)",group:"inventory",index:$(inventory)}
#
# @args		group (string)
#			index (int)
#			slot (string)
...
$item modify entity @s $(slot) mgs:v5.0.1/zb_slot_tag
