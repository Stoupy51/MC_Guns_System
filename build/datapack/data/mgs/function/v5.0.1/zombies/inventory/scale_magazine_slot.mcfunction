...
#> mgs:v5.0.1/zombies/inventory/scale_magazine_slot
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/inventory/give_starting_loadout {slot:"inventory.1",index:1,remaining_multiplier:0.5}
#			mgs:v5.0.1/zombies/wallbuys/give_to_slot {slot:"inventory.$(inventory)",index:$(inventory),remaining_multiplier:1}
#			mgs:v5.0.1/zombies/wallbuys/reload_pair {slot:"inventory.$(inventory)",index:$(inventory),remaining_multiplier:1}
#			mgs:v5.0.1/zombies/wallbuys/replace_pair {slot:"inventory.$(inventory)",index:$(inventory),remaining_multiplier:1}
#
# @args		index (int)
...
$execute summon item_display run function mgs:v5.0.1/zombies/inventory/read_capacity {slot:"hotbar.$(index)",multiplier:6}
...
$item modify entity @s $(slot) mgs:v5.0.1/zb_mark_converted
