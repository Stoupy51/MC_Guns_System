...
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/preload_complete [ at @s ]
#			mgs:v5.0.1/zombies/inventory/give_respawn_loadout
#
...
function mgs:v5.0.1/zombies/inventory/apply_slot_tag {slot:"hotbar.0",group:"hotbar",index:0}

# hotbar.1 + inventory.1: starting weapon and scaled magazine
loot replace entity @s hotbar.1 loot mgs:i/m1911
function mgs:v5.0.1/zombies/inventory/apply_slot_tag {slot:"hotbar.1",group:"hotbar",index:1}

loot replace entity @s inventory.1 loot mgs:i/m1911_mag
function mgs:v5.0.1/zombies/inventory/scale_magazine_slot {slot:"inventory.1",index:1,remaining_multiplier:0.5}
...
execute if score @s mgs.zb.ability matches 3.. run function mgs:v5.0.1/zombies/inventory/give_ability_item
