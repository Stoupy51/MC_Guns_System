...
#> mgs:v5.0.1/zombies/inventory/give_ability_item
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/inventory/give_starting_loadout
#
...
function mgs:v5.0.1/zombies/inventory/apply_slot_tag {slot:"hotbar.4",group:"hotbar",index:4}
