...
#> mgs:v5.0.1/zombies/doors/on_hover
#
# @executed	as @e[tag=mgs.door_new]
#
# @within	mgs:v5.0.1/zombies/doors/setup_iter {run:"function mgs:v5.0.1/zombies/doors/on_hover",executor:"source"} [ as @e[tag=mgs.door_new] ]
#
