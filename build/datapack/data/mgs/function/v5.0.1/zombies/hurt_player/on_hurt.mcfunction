...
#> mgs:v5.0.1/zombies/hurt_player/on_hurt
#
# @executed	as the player & at current position
#
# @within	advancement mgs:v5.0.1/zombies/hurt_player
#

# Revoke advancement and stop if the player is not in the zombies game
advancement revoke @s only mgs:v5.0.1/zombies/hurt_player
...
function mgs:v5.0.1/zombies/hurt_player/launch_downward
