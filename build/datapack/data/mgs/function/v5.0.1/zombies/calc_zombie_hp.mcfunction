...
# R1-9: linear growth
execute if score #zb_round mgs.data matches ..9 run function mgs:v5.0.1/zombies/calc_zombie_hp_linear

# R10+: exponential growth
execute if score #zb_round mgs.data matches 10.. run function mgs:v5.0.1/zombies/calc_zombie_hp_exp
