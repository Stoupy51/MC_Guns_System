...
#> mgs:v5.0.1/zombies/perks/on_hover
#
# @executed	as @n[tag=mgs.pk_new]
#
# @within	mgs:v5.0.1/zombies/perks/setup_iter {run:"function mgs:v5.0.1/zombies/perks/on_hover",executor:"source"} [ as @n[tag=mgs.pk_new] ]
#
...
function mgs:v5.0.1/zombies/perks/lookup_perk with storage mgs:temp _pk_hover
function mgs:v5.0.1/zombies/perks/get_hover_name
