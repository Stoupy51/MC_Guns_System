...
#> mgs:v5.0.1/zombies/perks/setup_iter
#
# @within	mgs:v5.0.1/zombies/perks/setup
#			mgs:v5.0.1/zombies/perks/setup_iter
#
...
function mgs:v5.0.1/zombies/perks/place_at with storage mgs:temp _pk
...
function mgs:v5.0.1/zombies/perks/store_data with storage mgs:temp _pk_store
...
execute as @n[tag=mgs.pk_new] at @s align xyz positioned ~.5 ~-.37 ~.5 positioned ^ ^ ^-0.5 run function mgs:v5.0.1/zombies/display/summon_machine_display with storage mgs:temp _pk_disp
...
execute if data storage mgs:temp _pk_iter[0] run function mgs:v5.0.1/zombies/perks/setup_iter
