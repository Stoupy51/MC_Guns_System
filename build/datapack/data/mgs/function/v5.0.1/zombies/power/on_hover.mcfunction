...
#> mgs:v5.0.1/zombies/power/on_hover
#
# @executed	as @e[tag=_pw_new]
#
# @within	mgs:v5.0.1/zombies/power/place_at {run:"function mgs:v5.0.1/zombies/power/on_hover",executor:"source"} [ as @e[tag=_pw_new] ]
#
