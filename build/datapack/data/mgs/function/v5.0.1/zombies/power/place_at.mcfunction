...
#> mgs:v5.0.1/zombies/power/place_at
#
# @within	mgs:v5.0.1/zombies/power/setup_iter with storage mgs:temp _pw
#
# @args		x (unknown)
#			y (unknown)
#			z (unknown)
...
execute as @e[tag=_pw_new] run function #bs.interaction:on_right_click {run:"function mgs:v5.0.1/zombies/power/on_activate",executor:"source"}
execute as @e[tag=_pw_new] run function #bs.interaction:on_hover {run:"function mgs:v5.0.1/zombies/power/on_hover",executor:"source"}
