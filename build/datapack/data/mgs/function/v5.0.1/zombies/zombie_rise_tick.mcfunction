...
#> mgs:v5.0.1/zombies/zombie_rise_tick
#
# @executed	at @s
#
...
function mgs:v5.0.1/zombies/zombie_rise_particles with storage mgs:temp _rise_particle

# Count down rise timer
scoreboard players remove @s mgs.zb.rise_tick 1
execute if score @s mgs.zb.rise_tick matches ..0 run function mgs:v5.0.1/zombies/zombie_finish_rise
