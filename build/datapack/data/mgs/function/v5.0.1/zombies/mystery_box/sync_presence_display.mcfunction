...
#> mgs:v5.0.1/zombies/mystery_box/sync_presence_display
#
...
execute as @n[tag=mgs.mystery_box_active] at @s run function mgs:v5.0.1/zombies/mystery_box/summon_presence_display with storage mgs:temp _mb_chest
