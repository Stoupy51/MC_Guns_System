...
#> mgs:v5.0.1/zombies/mystery_box/cycle_step
#
# @within	mgs:v5.0.1/zombies/mystery_box/spin_tick
#
...
execute if score #mb_elapsed mgs.data matches ..29 if score #mb_mod mgs.data matches 0 run function mgs:v5.0.1/zombies/mystery_box/cycle_display
...
execute if score #mb_elapsed mgs.data matches 30..49 if score #mb_mod mgs.data matches 0 run function mgs:v5.0.1/zombies/mystery_box/cycle_display
...
execute if score #mb_elapsed mgs.data matches 50.. if score #mb_mod mgs.data matches 0 run function mgs:v5.0.1/zombies/mystery_box/cycle_display
