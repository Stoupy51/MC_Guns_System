...
#> mgs:v5.0.1/zombies/mystery_box/setup_pos_iter
#
# @within	mgs:v5.0.1/zombies/mystery_box/setup_positions
#			mgs:v5.0.1/zombies/mystery_box/setup_pos_iter
#
...
execute as @n[tag=mgs.mb_new] run function #bs.interaction:on_right_click {run:"function mgs:v5.0.1/zombies/mystery_box/on_right_click",executor:"source"}
execute as @n[tag=mgs.mb_new] run function #bs.interaction:on_hover {run:"function mgs:v5.0.1/zombies/mystery_box/on_hover",executor:"source"}
