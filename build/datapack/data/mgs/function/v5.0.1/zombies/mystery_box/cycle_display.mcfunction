...
#> mgs:v5.0.1/zombies/mystery_box/cycle_display
#
# @within	mgs:v5.0.1/zombies/mystery_box/cycle_step
#
...
execute if data storage mgs:temp _mb_cycle_item.weapon_id run function mgs:v5.0.1/zombies/mystery_box/cycle_display_weapon with storage mgs:temp _mb_cycle_item
