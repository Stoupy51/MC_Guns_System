...
execute as @n[tag=mgs.mystery_box_active] at @s as @e[tag=mgs.mb_presence] run data modify entity @s Rotation set from entity @n[tag=mgs.mystery_box_active] Rotation
