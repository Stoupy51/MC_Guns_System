...
#> mgs:v5.0.1/zombies/mystery_box/move_anim_transition
#
# @within	mgs:v5.0.1/zombies/mystery_box/move_anim_tick
#

# Pick new active position
function mgs:v5.0.1/zombies/mystery_box/move_active_position
...
execute as @n[tag=mgs.mystery_box_active] at @s positioned ~ ~7.04 ~ run summon minecraft:item_display ~ ~ ~ {Tags:["mgs.mb_presence","mgs.gm_entity"],item_display:"fixed",billboard:"fixed",item:{id:"minecraft:chest",count:1},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.85f,0.85f,0.85f]},teleport_duration:5}
...
execute as @n[tag=mgs.mystery_box_active] at @s run function mgs:v5.0.1/zombies/feedback/sound_box_poof
