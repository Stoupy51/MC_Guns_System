...
#> mgs:v5.0.1/zombies/mystery_box/cycle_display_one
#
# @executed	as @e[tag=...] & at @s
#
# @within	mgs:v5.0.1/zombies/mystery_box/cycle_step_one
#
...
execute if data storage mgs:temp _mb_cycle_item.weapon_id run function mgs:v5.0.1/zombies/mystery_box/cycle_display_weapon_one with storage mgs:temp _mb_cycle_item
