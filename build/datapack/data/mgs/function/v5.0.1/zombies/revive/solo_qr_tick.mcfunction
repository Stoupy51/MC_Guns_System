...
#> mgs:v5.0.1/zombies/revive/solo_qr_tick
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/revive/check_solo_qr
#
...
execute if score @s mgs.zb.revive_p matches 200.. run function mgs:v5.0.1/zombies/revive/solo_qr_complete
