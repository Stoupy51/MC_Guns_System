...
#> mgs:v5.0.1/zombies/revive/revive_complete
#
# @executed	at @s
#
# @within	mgs:v5.0.1/zombies/revive/downed_tick
#			mgs:v5.0.1/zombies/revive/solo_qr_complete
#
...
execute if score #rv_pos_ok mgs.data matches 1 run function mgs:v5.0.1/zombies/revive/tp_revive_pos with storage mgs:temp
execute unless score #rv_pos_ok mgs.data matches 1 run function mgs:v5.0.1/zombies/revive/respawn_near_player
