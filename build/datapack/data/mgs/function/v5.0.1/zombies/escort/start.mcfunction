...
#> mgs:v5.0.1/zombies/escort/start
#
...
execute as @n[tag=mgs.zb_escort_new] run function mgs:v5.0.1/zombies/escort/set_trader_speed with storage mgs:temp _escort
...
execute as @n[tag=mgs.zb_escort_new] at @s run function mgs:v5.0.1/zombies/escort/retarget
