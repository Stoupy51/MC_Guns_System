...
#> mgs:v5.0.1/zombies/wallbuys/on_hover
#
# @executed	as @n[tag=mgs.wb_new]
#
# @within	mgs:v5.0.1/zombies/wallbuys/setup_iter {run:"function mgs:v5.0.1/zombies/wallbuys/on_hover",executor:"source"} [ as @n[tag=mgs.wb_new] ]
#
...
function mgs:v5.0.1/zombies/wallbuys/get_hover_name with storage mgs:temp _wb_hover
...
function mgs:v5.0.1/zombies/wallbuys/set_hover_price_suffix
