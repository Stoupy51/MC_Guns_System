...
#> mgs:v5.0.1/zombies/traps/on_hover
#
# @executed	as @e[tag=mgs._trap_new_bs]
#
# @within	mgs:v5.0.1/zombies/traps/setup_iter {run:"function mgs:v5.0.1/zombies/traps/on_hover",executor:"source"} [ as @e[tag=mgs._trap_new_bs] ]
#
