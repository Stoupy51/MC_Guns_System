...
#> mgs:v5.0.1/zombies/types/normal
#
# @within	mgs:v5.0.1/zombies/types/armed {level:"$(level)"}
#			mgs:v5.0.1/zombies/types/fast {level:"$(level)"}
#			mgs:v5.0.1/zombies/types/tank {level:"$(level)"}
#
