...
#> mgs:v5.0.1/grenade/flash_check
#
# @executed	as @e[tag=mgs.grenade] & at @s
#
# @within	mgs:v5.0.1/grenade/flash_area
#
...
execute if entity @e[tag=mgs.flash_source,distance=..3] run return run function mgs:v5.0.1/grenade/flash_player
...
function mgs:v5.0.1/grenade/flash_player
