...
execute unless score @s mgs.special.infinite_ammo matches 1.. run item modify entity @p[tag=mgs.ticking] weapon.mainhand mgs:v5.0.1/grenade/consume_one
