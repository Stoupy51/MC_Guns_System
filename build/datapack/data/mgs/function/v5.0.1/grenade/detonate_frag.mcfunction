...
#> mgs:v5.0.1/grenade/detonate_frag
#
# @executed	as @e[tag=mgs.grenade] & at @s
#
# @within	mgs:v5.0.1/grenade/detonate
#
...
execute if score #grenade_explosion_power mgs.config matches 1.. run function mgs:v5.0.1/grenade/realistic_explosion
...
# Delete the grenade
function mgs:v5.0.1/grenade/delete
