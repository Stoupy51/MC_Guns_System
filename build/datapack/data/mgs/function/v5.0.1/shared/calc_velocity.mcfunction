...
#> mgs:v5.0.1/shared/calc_velocity
#
# @executed	anchored eyes & positioned ^ ^ ^0.69
#
# @within	mgs:v5.0.1/projectile/init
#			mgs:v5.0.1/grenade/init
#
...
function mgs:v5.0.1/shared/tp_back with storage mgs:temp _tp_pos
