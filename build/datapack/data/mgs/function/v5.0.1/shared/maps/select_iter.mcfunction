...
#> mgs:v5.0.1/shared/maps/select_iter
#
# @within	mgs:v5.0.1/shared/maps/select_iter
#			mgs:v5.0.1/zombies/map_select
#			mgs:v5.0.1/multiplayer/map_select
#			mgs:v5.0.1/missions/map_select
#
...
# Call shared entry
function mgs:v5.0.1/shared/maps/select_entry with storage mgs:temp _map_entry

# Advance
data remove storage mgs:temp _map_iter[0]
scoreboard players add #map_idx mgs.data 1
execute if data storage mgs:temp _map_iter[0] run function mgs:v5.0.1/shared/maps/select_iter
