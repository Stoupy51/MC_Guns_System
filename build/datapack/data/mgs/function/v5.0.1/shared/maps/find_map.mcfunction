...
#> mgs:v5.0.1/shared/maps/find_map
#
# @within	mgs:v5.0.1/shared/maps/load
#			mgs:v5.0.1/shared/maps/find_map
#
...
function mgs:v5.0.1/shared/maps/check_map_id with storage mgs:temp map_load.target
...
function mgs:v5.0.1/shared/maps/find_map
