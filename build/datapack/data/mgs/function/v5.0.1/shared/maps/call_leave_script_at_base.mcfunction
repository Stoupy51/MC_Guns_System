...
#> mgs:v5.0.1/shared/maps/call_leave_script_at_base
#
# @executed	as @a[scores={mgs.zb.in_game=1}]
#
# @within	mgs:v5.0.1/zombies/stop [ as @a[scores={mgs.zb.in_game=1}] ]
#			mgs:v5.0.1/multiplayer/stop [ as @a[scores={mgs.mp.in_game=1}] ]
#			mgs:v5.0.1/missions/stop [ as @a[scores={mgs.mi.in_game=1}] ]
#
