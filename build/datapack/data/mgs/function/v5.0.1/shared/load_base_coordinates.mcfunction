...
#> mgs:v5.0.1/shared/load_base_coordinates
#
# @within	mgs:v5.0.1/shared/summon_oob {mode:"$(mode)"}
#			mgs:v5.0.1/zombies/start {mode:"zombies"}
#			mgs:v5.0.1/multiplayer/start {mode:"multiplayer"}
#			mgs:v5.0.1/multiplayer/gamemodes/dom/setup {mode:"multiplayer"}
#			mgs:v5.0.1/multiplayer/gamemodes/hp/setup {mode:"multiplayer"}
#			mgs:v5.0.1/multiplayer/gamemodes/snd/setup {mode:"multiplayer"}
#			mgs:v5.0.1/missions/start {mode:"missions"}
#
# @args		mode (string)
#
