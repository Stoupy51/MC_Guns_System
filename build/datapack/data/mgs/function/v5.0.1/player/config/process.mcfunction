...
#> mgs:v5.0.1/player/config/process
#
...
function mgs:v5.0.1/multiplayer/editor/load_state with storage mgs:temp
...
execute if score @s mgs.player.config matches 1 run function mgs:v5.0.1/player/config/menu
execute if score @s mgs.player.config matches 2 run function mgs:v5.0.1/player/config/toggle_hitmarker
execute if score @s mgs.player.config matches 3 run function mgs:v5.0.1/player/config/toggle_damage_debug
execute if score @s mgs.player.config matches 4 run function mgs:v5.0.1/multiplayer/select_class
execute if score @s mgs.player.config matches 5 run function mgs:v5.0.1/zombies/passive_ability_menu
execute if score @s mgs.player.config matches 6 run function mgs:v5.0.1/zombies/perks/set_passive_1
execute if score @s mgs.player.config matches 7 run function mgs:v5.0.1/zombies/perks/set_passive_2
execute if score @s mgs.player.config matches 8 run function mgs:v5.0.1/zombies/perks/set_ability_1
execute if score @s mgs.player.config matches 9 run function mgs:v5.0.1/zombies/perks/set_ability_2
execute if score @s mgs.player.config matches 11 run function mgs:v5.0.1/multiplayer/set_class {class_num:1,class_name:"Assault"}
execute if score @s mgs.player.config matches 12 run function mgs:v5.0.1/multiplayer/set_class {class_num:2,class_name:"Rifleman"}
execute if score @s mgs.player.config matches 13 run function mgs:v5.0.1/multiplayer/set_class {class_num:3,class_name:"Support"}
execute if score @s mgs.player.config matches 14 run function mgs:v5.0.1/multiplayer/set_class {class_num:4,class_name:"Sniper"}
execute if score @s mgs.player.config matches 15 run function mgs:v5.0.1/multiplayer/set_class {class_num:5,class_name:"SMG"}
execute if score @s mgs.player.config matches 16 run function mgs:v5.0.1/multiplayer/set_class {class_num:6,class_name:"Shotgunner"}
execute if score @s mgs.player.config matches 17 run function mgs:v5.0.1/multiplayer/set_class {class_num:7,class_name:"Engineer"}
execute if score @s mgs.player.config matches 18 run function mgs:v5.0.1/multiplayer/set_class {class_num:8,class_name:"Medic"}
...
execute if score @s mgs.player.config matches 1601 run function mgs:v5.0.1/multiplayer/marketplace/browse_fav_only
# 1602 = Marketplace: sorted by most likes
execute if score @s mgs.player.config matches 1602 run function mgs:v5.0.1/multiplayer/marketplace/browse_likes
# 1603 = My Loadouts: favorites only
execute if score @s mgs.player.config matches 1603 run function mgs:v5.0.1/multiplayer/my_loadouts/browse_fav_only

# Save per-player editor state back to isolated storage
function mgs:v5.0.1/multiplayer/editor/save_state with storage mgs:temp
