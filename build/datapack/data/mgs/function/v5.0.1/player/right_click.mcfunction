...
execute if score @s mgs.pending_clicks matches -60 if data storage mgs:gun all.gun run function mgs:v5.0.1/ammo/modify_lore {slot:"weapon.mainhand"}
...
execute unless score @s mgs.special.infinite_ammo matches 1.. if score @s mgs.remaining_bullets matches ..0 run return run function mgs:v5.0.1/ammo/reload
...
execute if score #fire_mode_is_burst mgs.data matches 1 if score @s mgs.burst_count matches 0 run function mgs:v5.0.1/player/init_burst_clicks
...
function mgs:v5.0.1/player/fire_weapon
...
function mgs:v5.0.1/kicks/main

# Drop casing
function mgs:v5.0.1/casing/main

# Decrease bullet count
function mgs:v5.0.1/ammo/decrease

# Advanced Playsound
function mgs:v5.0.1/sound/main
