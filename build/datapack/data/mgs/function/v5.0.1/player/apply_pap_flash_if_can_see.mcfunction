...
#> mgs:v5.0.1/player/apply_pap_flash_if_can_see
#
# @executed	at @s & anchored eyes & positioned ^ ^ ^0.001 & as @a[distance=..16]
#
# @within	mgs:v5.0.1/player/fire_weapon [ at @s & anchored eyes & positioned ^ ^ ^0.001 & as @a[distance=..16] ]
#
...
execute if score #can_see mgs.data matches 1 run particle minecraft:dust{color:[0.02,1.0,0.0],scale:0.01} ~ ~ ~ 0 0 0 0 1 force @s
