...
execute if data storage mgs:gun all.gun unless data storage mgs:gun all.stats.weapon_id run function mgs:v5.0.1/switch/set_weapon_id
...
execute unless score @s mgs.last_selected = #current_id mgs.data run function mgs:v5.0.1/switch/on_weapon_switch
