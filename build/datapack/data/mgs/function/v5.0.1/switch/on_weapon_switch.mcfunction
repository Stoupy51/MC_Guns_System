...
#> mgs:v5.0.1/switch/on_weapon_switch
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/switch/main
#
...
execute if score @s mgs.special.quick_swap matches 1.. run function mgs:v5.0.1/switch/apply_quick_swap
...
execute if score @s mgs.last_selected matches 1.. run function mgs:v5.0.1/ammo/update_old_weapon
...
execute if score #current_id mgs.data matches 1.. run function mgs:v5.0.1/ammo/copy_data
