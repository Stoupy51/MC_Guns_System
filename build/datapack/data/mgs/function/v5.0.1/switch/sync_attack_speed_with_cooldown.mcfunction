...
#> mgs:v5.0.1/switch/sync_attack_speed_with_cooldown
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.1/switch/force_switch_animation
#
...
execute summon item_display run function mgs:v5.0.1/switch/modify_attack_speed
