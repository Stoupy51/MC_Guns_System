...
#> mgs:v5.1.0/raycast/main
#
# @executed	anchored eyes & positioned ^ ^ ^
#
# @within	mgs:v5.1.0/player/shoot [ anchored eyes & positioned ^ ^ ^ ]
...
data modify storage mgs:input with.on_entry_point set value "function mgs:v5.1.0/raycast/on_entry_point"
data modify storage mgs:input with.on_targeted_block set value "function mgs:v5.1.0/raycast/on_targeted_block"
