...
#> mgs:v5.1.0/ammo/found_mag_lore_line
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/ammo/search_mag_lore_loop with storage mgs:input with
#
# @args		slot (unknown)
#			index (unknown)
#			capacity (unknown)
...
$item replace entity @p[tag=mgs.modify_mag_lore] $(slot) from entity @s contents

# Clean up item display
kill @s

## sourceMappingURL=found_mag_lore_line.mcfunction.map
