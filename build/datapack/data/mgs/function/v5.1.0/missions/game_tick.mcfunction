...
execute as @a[scores={mgs.mi.in_game=1}] at @s run function mgs:v5.1.0/missions/update_compass
...
execute unless entity @e[tag=mgs.mission_enemy] run return run function mgs:v5.1.0/missions/victory
