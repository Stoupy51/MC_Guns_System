...
#> mgs:v5.1.0/missions/spawn_enemy_iter
#
# @within	mgs:v5.1.0/missions/spawn_all_enemies
#			mgs:v5.1.0/missions/spawn_enemy_iter
#
...
function mgs:v5.1.0/missions/call_enemy_function with storage mgs:temp _epos
