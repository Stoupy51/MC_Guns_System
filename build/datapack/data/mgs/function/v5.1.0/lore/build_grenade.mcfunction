...
execute if score #has_expl_damage mgs.data matches 1 run function mgs:v5.1.0/lore/append_expl_damage with storage mgs:input lore

# -- Explosion Radius (optional) --
execute if score #has_expl_radius mgs.data matches 1 run function mgs:v5.1.0/lore/append_expl_radius with storage mgs:input lore
