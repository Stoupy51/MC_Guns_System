...
execute if score @s mgs.zoom matches 1 run posteffect add @s mgs:flash_pap_zoom
execute if score @s mgs.zoom matches 1 run scoreboard players set @s mgs.flash_id 2
execute unless score @s mgs.zoom matches 1 run posteffect add @s mgs:flash_pap
execute unless score @s mgs.zoom matches 1 run scoreboard players set @s mgs.flash_id 4
