...
#> mgs:v5.1.0/utils/coord_stick_relative
#
...
execute if score #cs_state mgs.data matches 1 as @a[tag=mgs.coord_stick_user,limit=1] run function mgs:v5.1.0/utils/coord_stick_print with storage mgs:temp coord_stick.result
