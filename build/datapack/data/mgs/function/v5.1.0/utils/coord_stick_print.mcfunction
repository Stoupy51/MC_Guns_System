...
#> mgs:v5.1.0/utils/coord_stick_print
#
# @executed	as @a[tag=mgs.coord_stick_user,limit=1]
#
# @within	mgs:v5.1.0/utils/coord_stick_relative with storage mgs:temp coord_stick.result [ as @a[tag=mgs.coord_stick_user,limit=1] ]
#
# @args		x (int)
#			y (int)
#			z (int)
