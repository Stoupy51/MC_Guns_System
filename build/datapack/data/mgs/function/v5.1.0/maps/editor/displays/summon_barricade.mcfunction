...
#> mgs:v5.1.0/maps/editor/displays/summon_barricade
#
# @executed	align xyz & positioned ~.5 ~.5 ~.5
#
# @within	mgs:v5.1.0/maps/editor/displays/barricade with storage mgs:temp _ed_bar [ align xyz & positioned ~.5 ~.5 ~.5 ]
#
# @args		yaw (unknown)
#			block (unknown)
#
