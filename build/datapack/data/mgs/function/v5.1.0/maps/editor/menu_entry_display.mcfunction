...
$tellraw @s ["  ",{"text":"$(name)","color":"white"},{"text":" ($(id))","color":"gray"}," ",[{"text":"[","color":"yellow","click_event":{"action":"suggest_command","command":"/function mgs:v5.1.0/maps/editor/enter {idx:$(idx),mode:$(mode)}"},"hover_event":{"action":"show_text","value":"Edit this map"}},{"translate":"mgs.edit"},"]"]," ",[{"text":"[","color":"red","click_event":{"action":"suggest_command","command":"/function mgs:v5.1.0/maps/editor/delete {idx:$(idx),mode:$(mode)}"},"hover_event":{"action":"show_text","value":"Delete this map"}},{"translate":"mgs.delete"},"]"]]

## sourceMappingURL=menu_entry_display.mcfunction.map
