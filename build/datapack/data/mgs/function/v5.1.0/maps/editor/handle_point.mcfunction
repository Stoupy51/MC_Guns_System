...
#> mgs:v5.1.0/maps/editor/handle_point
#
...
function mgs:v5.1.0/maps/editor/summon_point_marker with storage mgs:temp _pos
...
execute if entity @s[tag=mgs.element.search_and_destroy] run tellraw @a[tag=mgs.map_editor] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.sd_demolition_placed","color":"gold"}]
