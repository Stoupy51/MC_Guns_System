...
#> mgs:v5.1.0/maps/editor/save_lists/missions
#
...
execute as @e[tag=mgs.element.mission_spawn] at @s run function mgs:v5.1.0/maps/editor/save_spawn {path:"mission"}
execute as @e[tag=mgs.element.enemy] at @s run function mgs:v5.1.0/maps/editor/save_enemy
