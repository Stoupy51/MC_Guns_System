...
#> mgs:v5.1.0/maps/editor/destroy_element
#
...
execute if entity @s[tag=mgs.element.respawn_command] run tellraw @a[tag=mgs.map_editor] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.respawn_command_removed","color":"dark_aqua"}]
...
execute if entity @s[tag=mgs.element.wunderfizz] run tellraw @a[tag=mgs.map_editor] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.der_wunderfizz_removed","color":"gold"}]
