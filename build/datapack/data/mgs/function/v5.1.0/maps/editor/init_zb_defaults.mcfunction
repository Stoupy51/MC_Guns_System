...
data modify storage mgs:temp map_edit.zb_defaults.perk_machine set value {name:"Juggernog",price:2500,partial_price:0,perk_id:"juggernog",power:1b,display_item:"",item_model:""}
