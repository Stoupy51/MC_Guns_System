...
#> mgs:v5.1.0/maps/editor/create/missions
#
# @within	mgs:v5.1.0/maps/editor/list/missions "hover_event": {"action": "show_text", "value": "Create a new Missions map"}}, "+ Create New Map", "]"]]
#
