...
#> mgs:v5.1.0/maps/editor/handle_config
#
...
function mgs:v5.1.0/maps/editor/handle_config_default_btn with storage mgs:temp _cfg
...
execute if entity @e[tag=mgs.element.enemy,distance=..10] run function mgs:v5.1.0/maps/editor/handle_config_nearest_enemy_btn with storage mgs:temp _cfg
...
execute if entity @e[tag=mgs.element.start_command,distance=..10] run function mgs:v5.1.0/maps/editor/handle_config_nearest_start_command_btn with storage mgs:temp _cfg
