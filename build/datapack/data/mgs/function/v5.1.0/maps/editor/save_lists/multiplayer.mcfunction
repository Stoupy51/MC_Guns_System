...
#> mgs:v5.1.0/maps/editor/save_lists/multiplayer
#
...
execute as @e[tag=mgs.element.red_spawn] at @s run function mgs:v5.1.0/maps/editor/save_spawn {path:"red"}
execute as @e[tag=mgs.element.blue_spawn] at @s run function mgs:v5.1.0/maps/editor/save_spawn {path:"blue"}
execute as @e[tag=mgs.element.general_spawn] at @s run function mgs:v5.1.0/maps/editor/save_spawn {path:"general"}
...
execute as @e[tag=mgs.element.search_and_destroy] at @s run function mgs:v5.1.0/maps/editor/save_point {path:"search_and_destroy"}
execute as @e[tag=mgs.element.domination] at @s run function mgs:v5.1.0/maps/editor/save_point {path:"domination"}
execute as @e[tag=mgs.element.hardpoint] at @s run function mgs:v5.1.0/maps/editor/save_point {path:"hardpoint"}
