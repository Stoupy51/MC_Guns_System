...
#> mgs:v5.1.0/maps/editor/summon_existing
#
...
function mgs:v5.1.0/maps/editor/summon_base_marker with storage mgs:temp _pos
...
execute if score @s mgs.mp.map_mode matches 0 run function mgs:v5.1.0/maps/editor/summon_existing/multiplayer
