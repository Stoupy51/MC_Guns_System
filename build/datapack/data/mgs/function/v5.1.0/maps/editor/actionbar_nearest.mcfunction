...
execute if entity @s[tag=mgs.element.search_and_destroy] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"💣 ","color":"gold"},{"translate":"mgs.sd_demolition"}]
...
execute if entity @s[tag=mgs.element.special_spawn] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"🐺 ","color":"dark_red"},{"translate":"mgs.special_spawn"}]
...
execute if entity @s[tag=mgs.element.wunderfizz] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"🎰 ","color":"gold"},{"translate":"mgs.der_wunderfizz"}]
execute if entity @s[tag=mgs.element.pap_machine] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"🔥 ","color":"dark_red"},{"translate":"mgs.pack_a_punch_2"}]
