...
#> mgs:v5.1.0/maps/editor/give_tools
#
# @within	mgs:v5.1.0/maps/editor/enter
#			mgs:v5.1.0/maps/editor/invite_all [ as @a[scores={mgs.mp.map_edit=1}] ]
...
item replace entity @s inventory.26 with minecraft:bat_spawn_egg[minecraft:item_name=["","💾 ",{"translate":"mgs.save_exit","color":"green","italic":false,"bold":true}],minecraft:item_model="minecraft:turtle_spawn_egg",minecraft:custom_data={mgs:{editor:true,type:"editor_save_exit"}},minecraft:entity_data={id:"minecraft:bat",NoAI:1b,Silent:1b,Invulnerable:1b,Tags:["mgs.new_element","mgs.element.editor_save_exit"]}]
...
item replace entity @s inventory.24 with minecraft:bat_spawn_egg[minecraft:item_name=["","💾 ",{"translate":"mgs.save","color":"aqua","italic":false,"bold":true}],minecraft:item_model="minecraft:axolotl_spawn_egg",minecraft:custom_data={mgs:{editor:true,type:"editor_save"}},minecraft:entity_data={id:"minecraft:bat",NoAI:1b,Silent:1b,Invulnerable:1b,Tags:["mgs.new_element","mgs.element.editor_save"]}]

# Coord stick utility
item replace entity @s inventory.23 with minecraft:warped_fungus_on_a_stick[minecraft:item_name=["","📐 ",{"translate":"mgs.coord_stick","color":"yellow","italic":false,"bold":true}],minecraft:custom_data={mgs:{coord_stick:true}},minecraft:item_model="minecraft:stick",minecraft:enchantment_glint_override=true]

# Mode-specific eggs
execute if score @s mgs.mp.map_disp matches 0 run function mgs:v5.1.0/maps/editor/give_tools/multiplayer
