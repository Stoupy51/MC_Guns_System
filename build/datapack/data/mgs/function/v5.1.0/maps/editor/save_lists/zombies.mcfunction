...
#> mgs:v5.1.0/maps/editor/save_lists/zombies
#
# @executed	as @p[tag=mgs.map_editor,distance=..6,sort=nearest]
#
# @within	mgs:v5.1.0/maps/editor/do_save
#
...
data modify storage mgs:temp map_edit.map.barricades set value []
...
execute as @e[tag=mgs.element.zombie_spawn] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"spawning_points.zombies"}
execute as @e[tag=mgs.element.wallbuy] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"wallbuys"}
execute as @e[tag=mgs.element.door] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"doors"}
execute as @e[tag=mgs.element.trap] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"traps"}
execute as @e[tag=mgs.element.perk_machine] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"perks"}
execute as @e[tag=mgs.element.mystery_box_pos] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"mystery_box.positions"}
execute as @e[tag=mgs.element.power_switch] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"power_switch"}
execute as @e[tag=mgs.element.out_of_bounds] at @s run function mgs:v5.1.0/maps/editor/save_point {path:"out_of_bounds"}
execute as @e[tag=mgs.element.boundary] at @s run function mgs:v5.1.0/maps/editor/save_point {path:"boundaries"}
execute as @e[tag=mgs.element.pap_machine] at @s run function mgs:v5.1.0/maps/editor/save_zb_object {path:"pap_machines"}
