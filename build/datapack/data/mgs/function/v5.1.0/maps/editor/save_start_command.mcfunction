...
#> mgs:v5.1.0/maps/editor/save_start_command
#
# @executed	as @e[tag=mgs.element.start_command] & at @s
#
# @within	mgs:v5.1.0/maps/editor/save_lists/multiplayer {path:"start_commands"} [ as @e[tag=mgs.element.start_command] & at @s ]
#			mgs:v5.1.0/maps/editor/save_lists/zombies {path:"start_commands"} [ as @e[tag=mgs.element.start_command] & at @s ]
#			mgs:v5.1.0/maps/editor/save_lists/missions {path:"start_commands"} [ as @e[tag=mgs.element.start_command] & at @s ]
#
# @args		path (string)
#
