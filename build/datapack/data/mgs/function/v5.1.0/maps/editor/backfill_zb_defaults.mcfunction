...
execute if entity @s[tag=mgs.element.perk_machine] unless data entity @s data.name run data modify entity @s data.name set value "Juggernog"
execute if entity @s[tag=mgs.element.perk_machine] unless data entity @s data.price run data modify entity @s data.price set value 2500
