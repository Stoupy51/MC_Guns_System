...
#> mgs:v5.1.0/projectile/match_shooter
#
# @executed	as @a
#
# @within	mgs:v5.1.0/projectile/explode [ as @a ]
#			mgs:v5.1.0/projectile/explode [ as @e[tag=mgs.armed] ]
#			mgs:v5.1.0/grenade/detonate_frag [ as @a ]
