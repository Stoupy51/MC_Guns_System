...
#> mgs:v5.1.0/projectile/damage_area
#
# @executed	at @s
#
# @within	mgs:v5.1.0/projectile/explode with storage mgs:temp expl
#			mgs:v5.1.0/grenade/detonate_frag with storage mgs:temp expl
#
