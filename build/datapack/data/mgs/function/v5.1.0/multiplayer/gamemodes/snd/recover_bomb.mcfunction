...
tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"text":"💣 ","color":"white"},{"translate":"mgs.the_bomb_carrier_left_the_game_bomb_dropped","color":"yellow"}]

## sourceMappingURL=recover_bomb.mcfunction.map
