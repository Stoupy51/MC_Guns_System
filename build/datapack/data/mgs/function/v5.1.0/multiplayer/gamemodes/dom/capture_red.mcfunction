...
#> mgs:v5.1.0/multiplayer/gamemodes/dom/capture_red
#
# @executed	at @s
#
...
execute if score #dom_prog mgs.data matches ..-1 if score @s mgs.mp.dom_progress matches 0.. run tag @a[distance=..5,scores={mgs.mp.team=1,mgs.mp.in_game=1}] add mgs.dom_capturer
...
tag @a remove mgs.dom_capturer
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 run tag @a[distance=..5,scores={mgs.mp.team=1,mgs.mp.in_game=1}] add mgs.dom_capturer
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_A] run tellraw @a[tag=!mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_a","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_A] run tellraw @a[tag=mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_a","color":"yellow"},[" ",{"text":"+20 XP","color":"gold"}]]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_B] run tellraw @a[tag=!mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_b","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_B] run tellraw @a[tag=mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_b","color":"yellow"},[" ",{"text":"+20 XP","color":"gold"}]]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_C] run tellraw @a[tag=!mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_c","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_C] run tellraw @a[tag=mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_c","color":"yellow"},[" ",{"text":"+20 XP","color":"gold"}]]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_D] run tellraw @a[tag=!mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_d","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_D] run tellraw @a[tag=mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_d","color":"yellow"},[" ",{"text":"+20 XP","color":"gold"}]]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_E] run tellraw @a[tag=!mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_e","color":"yellow"}]
execute if score @s mgs.mp.dom_progress matches 100 unless score @s mgs.mp.dom_owner matches 1 if entity @s[tag=mgs.dom_label_E] run tellraw @a[tag=mgs.dom_capturer] [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.red","color":"red"}," ",{"translate":"mgs.captured_point_e","color":"yellow"},[" ",{"text":"+20 XP","color":"gold"}]]
