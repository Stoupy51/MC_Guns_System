...
execute if score #snd_site_idx mgs.data matches 0 run data modify storage mgs:temp _snd_pos.label set value "A"
execute if score #snd_site_idx mgs.data matches 1 run data modify storage mgs:temp _snd_pos.label set value "B"
execute if score #snd_site_idx mgs.data matches 2 run data modify storage mgs:temp _snd_pos.label set value "C"
execute if score #snd_site_idx mgs.data matches 3 run data modify storage mgs:temp _snd_pos.label set value "D"
scoreboard players add #snd_site_idx mgs.data 1
