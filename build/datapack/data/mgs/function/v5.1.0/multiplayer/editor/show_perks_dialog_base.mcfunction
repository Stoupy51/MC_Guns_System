...
#> mgs:v5.1.0/multiplayer/editor/show_perks_dialog_base
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/editor/show_perks_dialog with storage mgs:temp
#
# @args		_pts (unknown)
#			_perk_count (unknown)
#
...
## sourceMappingURL=show_perks_dialog_base.mcfunction.map
