...
#> mgs:v5.1.0/multiplayer/editor/append_mag_loop
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/editor/append_mag_slots
#			mgs:v5.1.0/multiplayer/editor/append_mag_loop
#
...
function mgs:v5.1.0/multiplayer/editor/append_mag_regular with storage mgs:temp
