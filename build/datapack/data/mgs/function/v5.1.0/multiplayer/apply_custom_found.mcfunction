...
#> mgs:v5.1.0/multiplayer/apply_custom_found
#
# @executed	at @s
#
# @within	mgs:v5.1.0/multiplayer/apply_custom_class
#			mgs:v5.1.0/multiplayer/apply_custom_found
#
...
execute if score #entry_id mgs.data = #loadout_id mgs.data run return run function mgs:v5.1.0/multiplayer/apply_custom_match
...
## sourceMappingURL=apply_custom_found.mcfunction.map
