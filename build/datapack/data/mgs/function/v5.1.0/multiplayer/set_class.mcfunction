...
#> mgs:v5.1.0/multiplayer/set_class
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/player/config/process {class_num:1,class_name:"Assault"}
#			mgs:v5.1.0/player/config/process {class_num:2,class_name:"Rifleman"}
#			mgs:v5.1.0/player/config/process {class_num:3,class_name:"Support"}
#			mgs:v5.1.0/player/config/process {class_num:4,class_name:"Sniper"}
#			mgs:v5.1.0/player/config/process {class_num:5,class_name:"SMG"}
#			mgs:v5.1.0/player/config/process {class_num:6,class_name:"Shotgunner"}
#			mgs:v5.1.0/player/config/process {class_num:7,class_name:"Engineer"}
#			mgs:v5.1.0/player/config/process {class_num:8,class_name:"Medic"}
#			mgs:v5.1.0/player/config/process {class_num:9,class_name:"Marksman"}
#			mgs:v5.1.0/player/config/process {class_num:10,class_name:"Heavy"}
#
# @args		class_num (int)
#			class_name (string)
#
...
## sourceMappingURL=set_class.mcfunction.map
