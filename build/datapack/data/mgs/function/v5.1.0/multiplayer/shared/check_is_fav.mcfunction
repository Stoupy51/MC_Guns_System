...
#> mgs:v5.1.0/multiplayer/shared/check_is_fav
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/my_loadouts/build_list_favs
#			mgs:v5.1.0/multiplayer/my_loadouts/check_private_not_fav
