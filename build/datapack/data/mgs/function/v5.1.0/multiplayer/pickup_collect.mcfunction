...
execute if data entity @n[tag=mgs.mp_dropped_gun,distance=..3] item.components."minecraft:custom_data".mgs.drop_mag run function mgs:v5.1.0/multiplayer/pickup_give_mag
