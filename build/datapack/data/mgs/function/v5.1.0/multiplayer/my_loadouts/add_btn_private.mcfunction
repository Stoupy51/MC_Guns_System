...
#> mgs:v5.1.0/multiplayer/my_loadouts/add_btn_private
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/my_loadouts/prep_btn with storage mgs:temp _btn_data
#
# @args		name (unknown)
...
## sourceMappingURL=add_btn_private.mcfunction.map
