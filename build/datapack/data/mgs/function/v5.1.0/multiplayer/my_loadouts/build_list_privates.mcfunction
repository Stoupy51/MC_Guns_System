...
#> mgs:v5.1.0/multiplayer/my_loadouts/build_list_privates
#
...
execute if score #entry_owner mgs.data = @s mgs.mp.pid run function mgs:v5.1.0/multiplayer/my_loadouts/check_private_not_fav
