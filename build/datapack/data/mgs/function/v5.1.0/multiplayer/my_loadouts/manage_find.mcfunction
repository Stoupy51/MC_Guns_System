...
#> mgs:v5.1.0/multiplayer/my_loadouts/manage_find
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/my_loadouts/manage
#			mgs:v5.1.0/multiplayer/my_loadouts/manage_find
#
...
execute if score #entry_id mgs.data = #loadout_id mgs.data if score #entry_owner mgs.data = @s mgs.mp.pid run return run function mgs:v5.1.0/multiplayer/my_loadouts/manage_prep
