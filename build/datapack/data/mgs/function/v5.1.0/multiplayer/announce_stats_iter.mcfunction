...
#> mgs:v5.1.0/multiplayer/announce_stats_iter
#
# @within	mgs:v5.1.0/multiplayer/announce_stats_iter
...
scoreboard players operation #stat_max mgs.data > @a[tag=mgs.stat_cand] mgs.mp.kills
...
execute as @a[tag=mgs.stat_cand] if score @s mgs.mp.kills = #stat_max mgs.data if score #stat_found mgs.data matches 0 run function mgs:v5.1.0/multiplayer/announce_stats_one
