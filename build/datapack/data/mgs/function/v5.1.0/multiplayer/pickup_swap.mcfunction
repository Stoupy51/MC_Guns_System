...
execute if score #pick_sel mgs.data matches 2 run item replace entity @s hotbar.2 from entity @n[type=minecraft:item_display,tag=mgs.mp_dropped_gun,distance=..3] contents
