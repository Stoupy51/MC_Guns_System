...
#> mgs:v5.1.0/multiplayer/custom/toggle_vis_rebuild
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/custom/toggle_visibility
#			mgs:v5.1.0/multiplayer/custom/toggle_vis_rebuild
#
...
execute if score #vis_match mgs.data matches 1 run function mgs:v5.1.0/multiplayer/custom/toggle_entry_vis
