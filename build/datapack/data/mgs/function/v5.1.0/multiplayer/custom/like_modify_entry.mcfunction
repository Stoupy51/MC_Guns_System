...
#> mgs:v5.1.0/multiplayer/custom/like_modify_entry
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/custom/like_pd_rebuild
#
...
execute if data storage mgs:temp _liked_iter[0] run function mgs:v5.1.0/multiplayer/custom/like_check_each
