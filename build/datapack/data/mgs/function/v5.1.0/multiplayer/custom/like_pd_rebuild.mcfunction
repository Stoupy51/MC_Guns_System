...
#> mgs:v5.1.0/multiplayer/custom/like_pd_rebuild
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.1.0/multiplayer/custom/like
#			mgs:v5.1.0/multiplayer/custom/like_pd_rebuild
#
...
execute if score #pd_pid mgs.data = @s mgs.mp.pid run function mgs:v5.1.0/multiplayer/custom/like_modify_entry
