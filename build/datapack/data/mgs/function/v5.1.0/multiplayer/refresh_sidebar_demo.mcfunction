...
execute if entity @e[tag=mgs.demo_site_OT,scores={mgs.demo_state=0}] run data modify storage mgs:temp demo_sb.a set value '[[" ",{"translate":"mgs.neutral","color":"gold"}],["🔹 ",{"translate":"mgs.intact","color":"gray"}]]'
execute if entity @e[tag=mgs.demo_site_OT,scores={mgs.demo_state=1}] run data modify storage mgs:temp demo_sb.a set value '[[" ",{"translate":"mgs.neutral","color":"gold"}],["💣 ",{"translate":"mgs.planted","color":"red"}]]'
execute if entity @e[tag=mgs.demo_site_OT] run data modify storage mgs:temp demo_sb.b set value '" "'
