...
#> mgs:v5.1.0/zombies/pap/anim/restore_display_lookup
#
# @within	mgs:v5.1.0/zombies/pap/anim/restore_display with storage mgs:temp _pap_restore
#
# @args		id (unknown)
#
...
function mgs:v5.1.0/zombies/display/summon_machine_display with storage mgs:temp _pap_restore_disp
