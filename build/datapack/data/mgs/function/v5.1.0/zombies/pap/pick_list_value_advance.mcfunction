...
#> mgs:v5.1.0/zombies/pap/pick_list_value_advance
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.1.0/zombies/pap/pick_list_value_step
#
...
## sourceMappingURL=pick_list_value_advance.mcfunction.map
