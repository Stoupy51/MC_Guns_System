...
#> mgs:v5.1.0/zombies/pap/apply_to_slot
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.1.0/zombies/pap/on_right_click with storage mgs:temp _pap
#			mgs:v5.1.0/zombies/pap/upgrade_core with storage mgs:temp _pap
#			mgs:v5.1.0/zombies/pap/free_scope_reroll with storage mgs:temp _pap
#
# @args		slot (unknown)
#

$item modify entity @s $(slot) mgs:v5.1.0/zb_pap_apply_stats
$data modify storage mgs:temp _pap_name_data.slot set value "$(slot)"
function mgs:v5.1.0/zombies/pap/set_item_name_with_level with storage mgs:temp _pap_name_data
