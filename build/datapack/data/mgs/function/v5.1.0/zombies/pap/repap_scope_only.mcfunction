...
#> mgs:v5.1.0/zombies/pap/repap_scope_only
#
...
execute unless score @s mgs.zb.points matches 1000.. run return run function mgs:v5.1.0/zombies/pap/deny_not_enough_points_scope
