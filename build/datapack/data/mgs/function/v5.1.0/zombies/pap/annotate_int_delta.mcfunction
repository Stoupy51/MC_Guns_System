...
#> mgs:v5.1.0/zombies/pap/annotate_int_delta
#
# @executed	as @n[tag=mgs.pap_new]
#
# @within	mgs:v5.1.0/zombies/pap/annotate_lore
#			mgs:v5.1.0/zombies/pap/annotate_pellets_line
#
...
## sourceMappingURL=annotate_int_delta.mcfunction.map
