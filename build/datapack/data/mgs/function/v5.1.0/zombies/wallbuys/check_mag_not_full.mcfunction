...
#> mgs:v5.1.0/zombies/wallbuys/check_mag_not_full
#
...
$execute if items entity @s $(slot) *[custom_data~{mgs:{magazine:true}}] summon minecraft:item_display run function mgs:v5.1.0/zombies/wallbuys/read_mag_state {slot:"$(slot)"}
