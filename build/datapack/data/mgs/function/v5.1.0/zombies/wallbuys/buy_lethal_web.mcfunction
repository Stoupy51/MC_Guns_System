...
execute if items entity @s hotbar.7 *[custom_data~{mgs:{grenade_type:"web"}}] run return run function mgs:v5.1.0/zombies/wallbuys/refill_lethal with storage mgs:temp _wb_weapon
