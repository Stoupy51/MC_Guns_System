...
#> mgs:v5.1.0/zombies/powerups/random_perk_iter
#
# @executed	at @s
#
...
execute if score #pu_perk_roll mgs.data matches 0 run function mgs:v5.1.0/zombies/powerups/try_perk/juggernog
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 1 run function mgs:v5.1.0/zombies/powerups/try_perk/speed_cola
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 2 run function mgs:v5.1.0/zombies/powerups/try_perk/double_tap
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 3 run function mgs:v5.1.0/zombies/powerups/try_perk/quick_revive
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 4 run function mgs:v5.1.0/zombies/powerups/try_perk/mule_kick
execute if score #pu_perk_applied mgs.data matches 1 run return 0
execute if score #pu_perk_roll mgs.data matches 5 run function mgs:v5.1.0/zombies/powerups/try_perk/stamin_up
execute if score #pu_perk_applied mgs.data matches 1 run return 0
