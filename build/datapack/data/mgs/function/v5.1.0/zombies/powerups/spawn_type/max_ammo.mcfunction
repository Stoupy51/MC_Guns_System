...
#> mgs:v5.1.0/zombies/powerups/spawn_type/max_ammo
#
# @executed	at @s
#
...
scoreboard players set @n[type=minecraft:item,tag=mgs.pu_item_new] mgs.zb.pu.type 1
