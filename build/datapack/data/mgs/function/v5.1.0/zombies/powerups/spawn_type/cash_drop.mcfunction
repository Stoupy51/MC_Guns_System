...
#> mgs:v5.1.0/zombies/powerups/spawn_type/cash_drop
#
# @executed	at @s
#
...
$summon minecraft:item $(x) $(y) $(z) {Tags:["mgs.pu_item","mgs.pu_item_new","mgs.gm_entity"],PickupDelay:32767,Invulnerable:1b,Item:{id:"minecraft:emerald",count:1,components:{"minecraft:custom_data":{mgs:{powerup_uid:$(uid)}}}}}
scoreboard players set @n[type=minecraft:item,tag=mgs.pu_item_new] mgs.zb.pu.type 9
