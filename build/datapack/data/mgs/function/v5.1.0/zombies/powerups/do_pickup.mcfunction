...
execute unless entity @a[tag=mgs.pu_collecting] if entity @e[tag=mgs.downed_mannequin,distance=..1.5] run function mgs:v5.1.0/zombies/powerups/pickup_downed_collector
