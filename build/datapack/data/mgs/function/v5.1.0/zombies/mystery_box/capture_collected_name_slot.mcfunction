...
#> mgs:v5.1.0/zombies/mystery_box/capture_collected_name_slot
#
...
$execute summon item_display run function mgs:v5.1.0/zombies/mystery_box/extract_collected_item_name {slot:"$(slot)"}
