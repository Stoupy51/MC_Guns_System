...
#> mgs:v5.1.0/zombies/mystery_box/summon_temp_box
#
# @executed	as @e[tag=...] & at @s
#
# @within	mgs:v5.1.0/zombies/mystery_box/fire_sale_summon_box with storage mgs:temp _mb_fs
#
# @args		yaw (unknown)
#
...
## sourceMappingURL=summon_temp_box.mcfunction.map
