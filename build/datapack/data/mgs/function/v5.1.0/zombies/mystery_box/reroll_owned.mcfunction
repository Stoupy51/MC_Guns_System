...
#> mgs:v5.1.0/zombies/mystery_box/reroll_owned
#
# @within	mgs:v5.1.0/zombies/mystery_box/reroll_owned
#			mgs:v5.1.0/zombies/mystery_box/pick_for_buyer
#

scoreboard players set #mb_owned mgs.data 0
execute if data storage mgs:zombies mystery_box.result.weapon_id run function mgs:v5.1.0/zombies/mystery_box/check_owned_result with storage mgs:zombies mystery_box.result
