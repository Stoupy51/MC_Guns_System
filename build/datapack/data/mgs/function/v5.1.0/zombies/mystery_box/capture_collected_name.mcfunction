...
#> mgs:v5.1.0/zombies/mystery_box/capture_collected_name
#
# @executed	at @n[tag=bs.interaction.target]
#
# @within	mgs:v5.1.0/zombies/mystery_box/collect with storage mgs:zombies mystery_box.result
#
...
## sourceMappingURL=capture_collected_name.mcfunction.map
