...
#> mgs:v5.1.0/zombies/mystery_box/cycle_step_one
#
...
execute if score #mb_elapsed mgs.data matches ..29 if score #mb_mod mgs.data matches 0 run function mgs:v5.1.0/zombies/mystery_box/cycle_display_one

scoreboard players operation #mb_mod mgs.data = #mb_elapsed mgs.data
execute if score #mb_elapsed mgs.data matches 30..49 run scoreboard players operation #mb_mod mgs.data %= #mb_c5 mgs.data
execute if score #mb_elapsed mgs.data matches 30..49 if score #mb_mod mgs.data matches 0 run function mgs:v5.1.0/zombies/mystery_box/cycle_display_one
