...
#> mgs:v5.1.0/zombies/mystery_box/pick_random_result
#
...
execute if score #mb_pool_size mgs.data matches ..0 run return run function mgs:v5.1.0/zombies/mystery_box/deny_pool_empty
