...
#> mgs:v5.1.0/zombies/doors/unlock_group
#
# @executed	as @e[tag=mgs.door] & at @s
#
# @within	mgs:v5.1.0/zombies/doors/open_one with storage mgs:temp _door_unlock
#			mgs:v5.1.0/zombies/doors/unlock_back_group with storage mgs:temp _door_unlock
#
# @args		gid (unknown)
#
