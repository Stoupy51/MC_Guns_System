...
#> mgs:v5.1.0/zombies/inventory/place_perk/electric_cherry
#
...
function mgs:v5.1.0/zombies/inventory/place_perk_at/electric_cherry with storage mgs:temp _perk_place
