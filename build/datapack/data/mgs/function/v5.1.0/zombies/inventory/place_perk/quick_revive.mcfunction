...
#> mgs:v5.1.0/zombies/inventory/place_perk/quick_revive
#
...
function mgs:v5.1.0/zombies/inventory/place_perk_at/quick_revive with storage mgs:temp _perk_place
