...
execute if score @s mgs.zb.perk.double_tap matches 1 run function mgs:v5.1.0/zombies/inventory/place_perk_item {id:"double_tap",name:"Double Tap",color:"yellow"}
