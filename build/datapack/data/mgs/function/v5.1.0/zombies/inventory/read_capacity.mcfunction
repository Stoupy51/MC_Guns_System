...
#> mgs:v5.1.0/zombies/inventory/read_capacity
#
# @executed	at @s
#
# @within	mgs:v5.1.0/zombies/inventory/scale_magazine_slot {slot:"hotbar.$(index)",multiplier:6}
#
# @args		slot (string)
#			multiplier (int)
#
...
## sourceMappingURL=read_capacity.mcfunction.map
