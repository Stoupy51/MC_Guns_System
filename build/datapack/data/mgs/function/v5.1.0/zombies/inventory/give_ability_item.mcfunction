...
#> mgs:v5.1.0/zombies/inventory/give_ability_item
#
# @executed	at @s
#
# @within	mgs:v5.1.0/zombies/inventory/give_starting_loadout
#
...
function mgs:v5.1.0/zombies/inventory/apply_slot_tag {slot:"hotbar.4",group:"hotbar",index:4}

## sourceMappingURL=give_ability_item.mcfunction.map
