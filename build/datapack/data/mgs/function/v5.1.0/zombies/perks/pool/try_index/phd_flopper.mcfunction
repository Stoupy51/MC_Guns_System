...
execute if score #pool_slot mgs.data matches 1 run scoreboard players set #pool_chosen mgs.data 6
execute if score #pool_slot mgs.data matches 1 run data modify storage mgs:temp _pool.perk_id set value "phd_flopper"
