...
tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"text":"🥤 ","color":"white"},{"storage":"mgs:temp","nbt":"_pk_hover_name","color":"light_purple","interpret":true},{"text":": ","color":"gray"},{"score":{"name":"#pk_paid","objective":"mgs.data"},"color":"green"},{"text":"/","color":"gray"},{"score":{"name":"#pk_total","objective":"mgs.data"},"color":"yellow"},[{"text":" ","color":"gray"}, {"translate":"mgs.points_paid"}]]
playsound minecraft:block.note_block.pling ambient @s ~ ~ ~ 0.8 1.45

## sourceMappingURL=announce_progress.mcfunction.map
