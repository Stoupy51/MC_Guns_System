...
#> mgs:v5.1.0/zombies/perks/pool/try_index/stamin_up
#
...
execute if score #pool_slot mgs.data matches 1 run scoreboard players set #pool_chosen mgs.data 5
execute if score #pool_slot mgs.data matches 1 run data modify storage mgs:temp _pool.perk_id set value "stamin_up"
