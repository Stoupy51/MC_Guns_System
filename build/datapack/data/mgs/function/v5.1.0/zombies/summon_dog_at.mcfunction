...
#
# @within	mgs:v5.1.0/zombies/dog_portal_strike with storage mgs:temp _zpos
#
# @args		level (unknown)
#
...
$execute as @n[tag=mgs.zb_dog_new] run function mgs:v5.1.0/zombies/types/dog {level:"$(level)"}
