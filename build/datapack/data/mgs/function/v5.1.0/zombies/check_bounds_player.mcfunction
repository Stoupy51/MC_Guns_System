...
#> mgs:v5.1.0/zombies/check_bounds_player
#
# @executed	at @s
#
...
execute if score @s mgs.mp.bx < #bound_x1 mgs.data run return run function mgs:v5.1.0/zombies/revive/full_death
execute if score @s mgs.mp.bx > #bound_x2 mgs.data run return run function mgs:v5.1.0/zombies/revive/full_death
execute if score @s mgs.mp.by < #bound_y1 mgs.data run return run function mgs:v5.1.0/zombies/revive/full_death
execute if score @s mgs.mp.by > #bound_y2 mgs.data run return run function mgs:v5.1.0/zombies/revive/full_death
