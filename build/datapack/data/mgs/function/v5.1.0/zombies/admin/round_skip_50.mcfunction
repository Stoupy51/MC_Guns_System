...
scoreboard players add #zb_round mgs.data 49
...
tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.an_operator_skipped_ahead_50_rounds","color":"yellow"}]

## sourceMappingURL=round_skip_50.mcfunction.map
