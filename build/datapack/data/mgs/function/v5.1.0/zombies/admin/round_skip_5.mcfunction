...
scoreboard players add #zb_round mgs.data 4
...
tellraw @a [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.an_operator_skipped_ahead_5_rounds","color":"yellow"}]

## sourceMappingURL=round_skip_5.mcfunction.map
