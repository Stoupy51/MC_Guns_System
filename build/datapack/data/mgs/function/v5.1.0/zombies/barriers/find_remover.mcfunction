...
#> mgs:v5.1.0/zombies/barriers/find_remover
#
...
$execute as @e[tag=mgs.zombie_round,tag=!mgs.barrier_removing,distance=..$(radius),limit=1,sort=nearest] run function mgs:v5.1.0/zombies/barriers/start_removing_zombie
