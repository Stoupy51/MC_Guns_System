...
#> mgs:v5.1.0/zombies/barriers/repair
#
...
execute as @a[tag=mgs.barrier_repairing] if score @s mgs.zb.barrier.repairing_id = #barrier_id mgs.data run function mgs:v5.1.0/zombies/barriers/on_repair_complete_player
