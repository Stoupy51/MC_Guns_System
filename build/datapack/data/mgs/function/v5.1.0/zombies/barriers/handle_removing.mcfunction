...
#> mgs:v5.1.0/zombies/barriers/handle_removing
#
...
execute if score #barrier_remover_valid mgs.data matches 0 run function mgs:v5.1.0/zombies/barriers/cancel_remove
