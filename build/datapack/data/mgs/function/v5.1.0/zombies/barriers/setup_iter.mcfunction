...
#> mgs:v5.1.0/zombies/barriers/setup_iter
#
# @within	mgs:v5.1.0/zombies/barriers/setup
#			mgs:v5.1.0/zombies/barriers/setup_iter
#
...
function mgs:v5.1.0/zombies/barriers/place_at with storage mgs:temp _bplace
...
execute as @n[tag=mgs._barrier_new_d] at @s run function mgs:v5.1.0/zombies/barriers/compute_brightness
...
execute if data storage mgs:temp _barrier_iter[0] run function mgs:v5.1.0/zombies/barriers/setup_iter
