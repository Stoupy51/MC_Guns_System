...
#> mgs:v5.1.0/zombies/traps/setup_iter
#
# @within	mgs:v5.1.0/zombies/traps/setup
#			mgs:v5.1.0/zombies/traps/setup_iter
#
...
# Summon entities
function mgs:v5.1.0/zombies/traps/place_at with storage mgs:temp _trap
...
execute as @e[tag=mgs._trap_new_bs] run function #bs.interaction:on_right_click {run:"function mgs:v5.1.0/zombies/traps/on_right_click",executor:"source"}
execute as @e[tag=mgs._trap_new_bs] run function #bs.interaction:on_hover {run:"function mgs:v5.1.0/zombies/traps/on_hover",executor:"source"}
...
execute if score #trap_type mgs.data matches 2 run function mgs:v5.1.0/zombies/traps/place_turret_at with storage mgs:temp _trap
