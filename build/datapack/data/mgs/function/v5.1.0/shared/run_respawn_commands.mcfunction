...
#> mgs:v5.1.0/shared/run_respawn_commands
#
# @executed	at @s
#
# @within	mgs:v5.1.0/multiplayer/actual_respawn {mode:"multiplayer"} [ at @s ]
#			mgs:v5.1.0/missions/actual_respawn {mode:"missions"} [ at @s ]
#
# @args		mode (string)
#
...
## sourceMappingURL=run_respawn_commands.mcfunction.map
