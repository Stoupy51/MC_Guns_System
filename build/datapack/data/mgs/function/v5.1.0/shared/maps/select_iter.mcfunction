...
#> mgs:v5.1.0/shared/maps/select_iter
#
# @within	mgs:v5.1.0/shared/maps/select_iter
...
# Call shared entry
function mgs:v5.1.0/shared/maps/select_entry with storage mgs:temp _map_entry
