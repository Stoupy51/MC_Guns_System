...
#
# @within	advancement mgs:challenges/mp/objectives_3
#
...
data modify storage mgs:signals on_challenge_unlock set value {branch:"mp",chain:"objectives",tier:3,side:"mp",xp:30}
