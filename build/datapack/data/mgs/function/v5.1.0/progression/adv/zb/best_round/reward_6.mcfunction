...
#
# @within	advancement mgs:challenges/zb/best_round_6
#
...
data modify storage mgs:signals on_challenge_unlock set value {branch:"zb",chain:"best_round",tier:6,side:"zb",xp:175}
