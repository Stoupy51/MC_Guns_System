...
#> mgs:v5.1.0/progression/zb/bisect
#
# @executed	as @a
#
# @within	mgs:v5.1.0/progression/zb/recompute
#			mgs:v5.1.0/progression/zb/bisect
#
...
execute if score @s mgs.zb.xp_total >= #xp_need mgs.data run scoreboard players operation #xp_lo mgs.data = #xp_mid mgs.data
