...
#> mgs:v5.1.0/progression/mp/init
#
# @executed	as @a
#
...
scoreboard players add @s mgs.mp.xp_total 0
scoreboard players add @s mgs.mp.xp_prog 0
scoreboard players set @s mgs.mp.xp_level 1
