...
execute unless score @s mgs.mp.xp_total matches 0.. run scoreboard players set @s mgs.mp.xp_total 0
...
scoreboard players operation @s mgs.mp.xp_level = #xp_lo mgs.data
...
scoreboard players operation @s mgs.mp.xp_prog = @s mgs.mp.xp_total
scoreboard players operation @s mgs.mp.xp_prog -= #xp_need mgs.data
