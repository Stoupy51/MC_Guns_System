...
#> mgs:v5.1.0/grenade/flash_apply
#
# @executed	as @e[tag=mgs.grenade] & at @s
#
# @within	mgs:v5.1.0/grenade/detonate_flash
#
...
function mgs:v5.1.0/grenade/flash_area with storage mgs:temp flash

## sourceMappingURL=flash_apply.mcfunction.map
