...
$execute if score #bullets mgs.data matches 1.. if items entity @s $(slot) *[custom_data~{mgs:{consumable:true}}] run return run function mgs:v5.0.0/ammo/inventory/consume_partial {slot:"$(slot)"}
