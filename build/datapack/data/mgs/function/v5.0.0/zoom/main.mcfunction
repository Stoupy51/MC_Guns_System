...
execute if score @s mgs.zoom matches 1 unless score @s mgs.switch_cooldown > #total_tick mgs.data if score @s mgs.zoom_timer matches 5.. if score #scope_level mgs.data matches 3 at @s anchored eyes run particle minecraft:dust{color:[0.02,0.02,0.0],scale:0.01} ^ ^ ^0.1 0 0 0 0 1 force @s
execute if score @s mgs.zoom matches 1 unless score @s mgs.switch_cooldown > #total_tick mgs.data if score @s mgs.zoom_timer matches 5.. if score #scope_level mgs.data matches 4 at @s anchored eyes run particle minecraft:dust{color:[0.02,0.08,0.0],scale:0.01} ^ ^ ^0.1 0 0 0 0 1 force @s
execute if score @s mgs.zoom matches 1 unless score @s mgs.switch_cooldown > #total_tick mgs.data if score @s mgs.zoom_timer matches 5.. unless score #scope_level mgs.data matches 3 unless score #scope_level mgs.data matches 4 at @s anchored eyes run particle minecraft:dust{color:[0.02,0.25,0.0],scale:0.01} ^ ^ ^0.1 0 0 0 0 1 force @s
