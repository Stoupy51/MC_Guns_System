...
#> mgs:v5.0.0/multiplayer/my_loadouts/build_list_publics
#
...
execute if score #entry_owner mgs.data = @s mgs.mp.pid run function mgs:v5.0.0/multiplayer/my_loadouts/check_public_not_fav
