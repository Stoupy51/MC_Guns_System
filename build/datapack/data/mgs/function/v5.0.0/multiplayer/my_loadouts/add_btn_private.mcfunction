...
$data modify storage mgs:temp dialog.actions append value {label:[{text:"",color:"red"},"🗑 ",{text:"Delete"}],tooltip:{translate: "mgs.permanently_delete_this_loadout",color:"dark_red"},action:{type:"run_command",command:"/trigger mgs.player.config set $(delete_trig)"}}
