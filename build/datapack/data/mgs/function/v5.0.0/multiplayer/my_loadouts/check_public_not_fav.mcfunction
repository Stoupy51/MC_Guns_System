...
#
# @within	mgs:v5.0.0/multiplayer/my_loadouts/build_list_publics
#
...
execute if score #pub mgs.data matches 1 if score #is_fav mgs.data matches 0 run function mgs:v5.0.0/multiplayer/my_loadouts/prep_btn
