...
execute if score #_dom_prog mgs.data matches ..-1 if score @s mgs.mp.dom_progress matches 0.. run playsound minecraft:block.note_block.bass player @a ~ ~ ~ 1 0.5
...
execute if score #_dom_prog mgs.data matches ..-1 if score @s mgs.mp.dom_progress matches 0.. run data modify entity @n[tag=mgs.dom_label,distance=..1] text.color set value "yellow"
