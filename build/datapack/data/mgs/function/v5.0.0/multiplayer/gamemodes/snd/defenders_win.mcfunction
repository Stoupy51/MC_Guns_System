...
execute if score #snd_attackers mgs.data matches 1 run tellraw @a [[{"text":"","color":"gold"},"[",{"translate": "mgs"},"] "],{"translate": "mgs.blue","color":"blue"},{"translate": "mgs.defenders_win_the_round","color":"yellow"}]
execute if score #snd_attackers mgs.data matches 2 run scoreboard players add #snd_red_wins mgs.data 1
execute if score #snd_attackers mgs.data matches 2 run tellraw @a [[{"text":"","color":"gold"},"[",{"translate": "mgs"},"] "],{"translate": "mgs.red","color":"red"},{"translate": "mgs.defenders_win_the_round","color":"yellow"}]
