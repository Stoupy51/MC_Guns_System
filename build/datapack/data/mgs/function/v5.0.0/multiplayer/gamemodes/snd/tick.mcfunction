...
execute if score #snd_atk_alive mgs.data matches 0 if score #snd_bomb_state mgs.data matches ..1 run function mgs:v5.0.0/multiplayer/gamemodes/snd/defenders_win
...
execute if score #snd_def_alive mgs.data matches 0 run function mgs:v5.0.0/multiplayer/gamemodes/snd/attackers_win
