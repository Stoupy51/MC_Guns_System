...
#> mgs:v5.0.0/multiplayer/summon_spawn_iter
#
# @within	mgs:v5.0.0/multiplayer/summon_spawns
#			mgs:v5.0.0/multiplayer/summon_spawn_iter
#
...
# Summon
function mgs:v5.0.0/multiplayer/summon_spawn_at with storage mgs:temp _spos
