...
#> mgs:v5.0.0/multiplayer/custom/like_pd_rebuild
#
...
execute if score #pd_pid mgs.data = @s mgs.mp.pid run function mgs:v5.0.0/multiplayer/custom/like_modify_entry
