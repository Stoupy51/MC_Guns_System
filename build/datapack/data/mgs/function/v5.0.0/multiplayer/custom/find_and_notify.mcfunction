...
#> mgs:v5.0.0/multiplayer/custom/find_and_notify
#
...
execute if score #entry_id mgs.data = #loadout_id mgs.data run return run function mgs:v5.0.0/multiplayer/custom/notify_selected with storage mgs:temp _find_iter[0]
