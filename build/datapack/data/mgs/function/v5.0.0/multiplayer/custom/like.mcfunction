...
# Notify
execute if score #already_liked mgs.data matches 0 run tellraw @s ["",{"translate": "mgs","color":"gold"},{"translate": "mgs.loadout_liked","color":"green"}]
execute if score #already_liked mgs.data matches 1 run tellraw @s ["",{"translate": "mgs","color":"gold"},{"translate": "mgs.you_already_liked_this_loadout","color":"yellow"}]
