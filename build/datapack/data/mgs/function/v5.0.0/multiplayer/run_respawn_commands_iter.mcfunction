...
#> mgs:v5.0.0/multiplayer/run_respawn_commands_iter
#
# @executed	at @s
#
# @within	mgs:v5.0.0/multiplayer/run_respawn_commands [ at @s ]
#			mgs:v5.0.0/multiplayer/run_respawn_commands_iter [ at @s ]
#
...
function mgs:v5.0.0/multiplayer/run_respawn_command with storage mgs:temp _respawn_cmd
