...
#> mgs:v5.0.0/multiplayer/summon_oob_iter
#
# @within	mgs:v5.0.0/multiplayer/summon_oob
#			mgs:v5.0.0/multiplayer/summon_oob_iter
#
...
function mgs:v5.0.0/multiplayer/summon_oob_at with storage mgs:temp _oob_pos
data remove storage mgs:temp _oob_iter[0]
execute if data storage mgs:temp _oob_iter[0] run function mgs:v5.0.0/multiplayer/summon_oob_iter
