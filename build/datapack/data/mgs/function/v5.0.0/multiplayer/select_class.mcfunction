...
data modify storage mgs:temp dialog.actions append value {label:{text:"📦 My Loadouts",color:"yellow",bold:true},tooltip:{translate: "mgs.manage_your_custom_loadouts"},action:{type:"run_command",command:"/trigger mgs.player.config set 102"}}
