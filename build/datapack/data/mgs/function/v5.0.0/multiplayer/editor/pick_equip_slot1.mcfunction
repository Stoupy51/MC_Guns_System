...
execute if score @s mgs.player.config matches 461 run execute if score @s mgs.mp.edit_points matches ..0 run return run tellraw @s [{"translate": "mgs","color":"gold"},{"translate": "mgs.not_enough_points_for_a_grenade","color":"red"}]
...
execute if score @s mgs.player.config matches 462 run execute if score @s mgs.mp.edit_points matches ..0 run return run tellraw @s [{"translate": "mgs","color":"gold"},{"translate": "mgs.not_enough_points_for_a_grenade","color":"red"}]
...
execute if score @s mgs.player.config matches 463 run execute if score @s mgs.mp.edit_points matches ..0 run return run tellraw @s [{"translate": "mgs","color":"gold"},{"translate": "mgs.not_enough_points_for_a_grenade","color":"red"}]
...
execute if score @s mgs.player.config matches 464 run execute if score @s mgs.mp.edit_points matches ..0 run return run tellraw @s [{"translate": "mgs","color":"gold"},{"translate": "mgs.not_enough_points_for_a_grenade","color":"red"}]
