...
#> mgs:v5.0.0/multiplayer/editor/rebuild_perks_2
#
# @executed	as @e[type=player,sort=random] & at @s
#
# @within	mgs:v5.0.0/multiplayer/editor/remove_perk_2
#			mgs:v5.0.0/multiplayer/editor/rebuild_perks_2
#
...
execute unless data storage mgs:temp {_perk_val:"infinite_ammo"} run data modify storage mgs:temp editor.perks append from storage mgs:temp _perk_val
