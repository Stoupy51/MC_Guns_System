...
$data modify storage mgs:temp dialog set value {type:"minecraft:multi_action",title:{translate: "mgs.create_loadout_review",color:"gold",bold:true},body:[{type:"minecraft:plain_message",contents:["",{"translate": "mgs.points_used","color":"white"},{"translate": "mgs.placeholder","color":"gold"}]},{type:"minecraft:plain_message",contents:{translate: "mgs.review_your_loadout_before_saving",color:"white"}},{type:"minecraft:plain_message",contents:["",{"translate": "mgs.primary","color":"white"},{"text":"$(primary_name)","color":"green","bold":true},{"text":" ($(primary_scope_name)) x$(primary_mag_count) mags","color":"dark_green"}]},{type:"minecraft:plain_message",contents:["",{"translate": "mgs.secondary","color":"white"},{"text":"$(secondary_name)","color":"yellow","bold":true},{"text":" x$(secondary_mag_count) mags","color":"gold"}]},{type:"minecraft:plain_message",contents:["",{"translate": "mgs.equip_1","color":"white"},{"text":"$(equip_slot1)","color":"aqua","bold":true}]},{type:"minecraft:plain_message",contents:["",{"translate": "mgs.equip_2","color":"white"},{"text":"$(equip_slot2)","color":"aqua","bold":true}]}],actions:[{label:{translate: "mgs.save_as_public",color:"green"},tooltip:{translate: "mgs.everyone_can_see_and_use_this_loadout"},action:{type:"run_command",command:"/trigger mgs.player.config set 350"}},{label:{translate: "mgs.save_as_private",color:"yellow"},tooltip:{translate: "mgs.only_you_can_see_and_use_this_loadout"},action:{type:"run_command",command:"/trigger mgs.player.config set 351"}}],columns:2,after_action:"close",exit_action:{label:"Back",action:{type:"run_command",command:"/trigger mgs.player.config set 380"}}}
