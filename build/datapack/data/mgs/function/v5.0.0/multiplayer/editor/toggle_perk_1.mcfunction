...
#> mgs:v5.0.0/multiplayer/editor/toggle_perk_1
#
...
execute if data storage mgs:temp editor{perks:["quick_swap"]} run scoreboard players add @s mgs.mp.edit_points 1
execute if data storage mgs:temp editor{perks:["quick_swap"]} run return run function mgs:v5.0.0/multiplayer/editor/remove_perk_1
...
data modify storage mgs:temp editor.perks append value "quick_swap"
