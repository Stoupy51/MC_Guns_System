...
execute if score @s mgs.player.config matches 391 run execute if score @s mgs.mp.edit_points matches ..0 run return run tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.not_enough_points_for_1_magazines","color":"red"}]
...
execute if score @s mgs.player.config matches 392 run execute if score @s mgs.mp.edit_points matches ..1 run return run tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.not_enough_points_for_2_magazines","color":"red"}]
...
execute if score @s mgs.player.config matches 393 run execute if score @s mgs.mp.edit_points matches ..2 run return run tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.not_enough_points_for_3_magazines","color":"red"}]
...
execute if score @s mgs.player.config matches 394 run execute if score @s mgs.mp.edit_points matches ..3 run return run tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.not_enough_points_for_4_magazines","color":"red"}]
...
execute if score @s mgs.player.config matches 395 run execute if score @s mgs.mp.edit_points matches ..4 run return run tellraw @s [[{"text":"","color":"gold"},"[",{"translate":"mgs"},"] "],{"translate":"mgs.not_enough_points_for_5_magazines","color":"red"}]
