...
#> mgs:v5.0.0/multiplayer/editor/toggle_perk_2
#
...
execute if data storage mgs:temp editor{perks:["infinite_ammo"]} run scoreboard players add @s mgs.mp.edit_points 1
execute if data storage mgs:temp editor{perks:["infinite_ammo"]} run return run function mgs:v5.0.0/multiplayer/editor/remove_perk_2
...
data modify storage mgs:temp editor.perks append value "infinite_ammo"
