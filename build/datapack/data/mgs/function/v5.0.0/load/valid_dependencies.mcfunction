...
execute if score #dependency_error mgs.data matches 1 unless score $bs.move.major load.status matches 3.. run tellraw @a {"translate": "mgs.bookshelf_move_v3_2_2","color":"gold","click_event":{"action":"open_url","url":"https://github.com/mcbookshelf/bookshelf/releases"}}
execute if score #dependency_error mgs.data matches 1 if score $bs.move.major load.status matches 3 unless score $bs.move.minor load.status matches 2.. run tellraw @a {"translate": "mgs.bookshelf_move_v3_2_2","color":"gold","click_event":{"action":"open_url","url":"https://github.com/mcbookshelf/bookshelf/releases"}}
execute if score #dependency_error mgs.data matches 1 if score $bs.move.major load.status matches 3 if score $bs.move.minor load.status matches 2 unless score $bs.move.patch load.status matches 2.. run tellraw @a {"translate": "mgs.bookshelf_move_v3_2_2","color":"gold","click_event":{"action":"open_url","url":"https://github.com/mcbookshelf/bookshelf/releases"}}
