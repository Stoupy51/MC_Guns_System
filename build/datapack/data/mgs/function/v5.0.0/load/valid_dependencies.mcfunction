...
execute if score #dependency_error mgs.data matches 1 if score #smithed.actionbar.major load.status matches 0 if score #smithed.actionbar.minor load.status matches 6 unless score #smithed.actionbar.patch load.status matches 6.. run tellraw @a [{"text":"- ","color":"gold","click_event":{"action":"open_url","url":"https://wiki.smithed.dev/libraries/actionbar/"}}, {"translate":"mgs.smithed_actionbar_v0_6_6"}]
