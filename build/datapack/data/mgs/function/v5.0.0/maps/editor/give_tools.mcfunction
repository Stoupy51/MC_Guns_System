...
item replace entity @s inventory.25 with minecraft:bat_spawn_egg[minecraft:item_name={"translate": "mgs.exit","color":"red","italic":false,"bold":true},minecraft:item_model="minecraft:ghast_spawn_egg",minecraft:custom_data={mgs:{editor:true,type:"editor_exit"}},minecraft:entity_data={id:"minecraft:bat",NoAI:1b,Silent:1b,Invulnerable:1b,Tags:["mgs.new_element","mgs.element.editor_exit"]}]
