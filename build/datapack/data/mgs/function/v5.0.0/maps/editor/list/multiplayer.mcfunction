...
tellraw @s ""
tellraw @s ["  ",[{"text": "[", "color": "green", "click_event": {"action": "run_command", "command": "/function mgs:v5.0.0/maps/editor/create/multiplayer"}, "hover_event": {"action": "show_text", "value": "Create a new Multiplayer map"}}, "+ Create New Map", "]"]]
tellraw @s {"text":"============================================","color":"dark_gray"}
