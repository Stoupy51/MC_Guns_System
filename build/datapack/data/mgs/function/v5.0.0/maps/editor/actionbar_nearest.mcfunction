...
execute if entity @s[tag=mgs.element.red_spawn] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"● ","color":"red"},{"text":"Red Spawn"}]
execute if entity @s[tag=mgs.element.blue_spawn] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"● ","color":"blue"},{"text":"Blue Spawn"}]
execute if entity @s[tag=mgs.element.general_spawn] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"● ","color":"yellow"},{"text":"General Spawn"}]
...
execute if entity @s[tag=mgs.element.mission_spawn] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"● ","color":"aqua"},{"text":"Mission Spawn"}]
...
execute if entity @s[tag=mgs.element.wallbuy] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"🔫 ","color":"yellow"},{"text":"Wallbuy"}]
execute if entity @s[tag=mgs.element.door] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"🚪 ","color":"gold"},{"text":"Door"}]
execute if entity @s[tag=mgs.element.trap] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"⚡ ","color":"red"},{"text":"Trap"}]
execute if entity @s[tag=mgs.element.perk_machine] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"🧪 ","color":"dark_purple"},{"text":"Perk Machine"}]
execute if entity @s[tag=mgs.element.mystery_box_pos] run return run title @a[tag=mgs.check_nearest] actionbar [{"text":"📦 ","color":"light_purple"},{"text":"Mystery Box Pos"}]
