...
execute as @e[tag=mgs.element.blue_spawn] at @s run function mgs:v5.0.0/maps/editor/save_spawn {path:"blue"}
execute as @e[tag=mgs.element.general_spawn] at @s run function mgs:v5.0.0/maps/editor/save_spawn {path:"general"}
