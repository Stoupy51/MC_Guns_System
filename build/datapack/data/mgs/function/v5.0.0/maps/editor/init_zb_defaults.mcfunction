...
data modify storage mgs:temp map_edit.zb_defaults.wallbuy set value {price:1000,refill_price:500,refill_price_pap:4500,weapon_id:'m1911',magazine_id:'m1911_mag'}
...
data modify storage mgs:temp map_edit.zb_defaults.perk_machine set value {name:'Juggernog',price:2500,perk_id:'juggernog',power:1b}
