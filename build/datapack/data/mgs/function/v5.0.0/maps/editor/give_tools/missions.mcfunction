...
item replace entity @s hotbar.5 with minecraft:bat_spawn_egg[minecraft:item_name={"translate": "mgs.config","color":"white","italic":false},minecraft:item_model="minecraft:allay_spawn_egg",minecraft:custom_data={mgs:{editor:true,type:"config"}},minecraft:entity_data={id:"minecraft:bat",NoAI:1b,Silent:1b,Invulnerable:1b,Tags:["mgs.new_element","mgs.element.config"]}]
