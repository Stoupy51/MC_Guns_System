...
#> mgs:v5.0.0/maps/zombies/find_map
#
# @within	mgs:v5.0.0/maps/zombies/load
#			mgs:v5.0.0/maps/zombies/find_map
#
...
function mgs:v5.0.0/maps/zombies/check_map_id with storage mgs:temp map_load.target
