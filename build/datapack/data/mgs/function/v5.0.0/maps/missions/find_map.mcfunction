...
#> mgs:v5.0.0/maps/missions/find_map
#
# @within	mgs:v5.0.0/maps/missions/load
#			mgs:v5.0.0/maps/missions/find_map
#
...
function mgs:v5.0.0/maps/missions/check_map_id with storage mgs:temp map_load.target
