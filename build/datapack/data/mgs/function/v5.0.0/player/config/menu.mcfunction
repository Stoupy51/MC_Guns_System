...
tellraw @s {"text":"=======================================","color":"dark_gray"}
tellraw @s ["  ",{"translate":"mgs.use","color":"gray","italic":true}," ",[{"text":"/","color":"aqua","italic":true}, {"translate":"mgs.trigger_mgs_player_config"}]," ",{"translate":"mgs.to_reopen","color":"gray","italic":true}]
