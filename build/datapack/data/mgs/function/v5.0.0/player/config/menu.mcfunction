...
execute unless score @s mgs.player.damage_debug matches 1 run tellraw @s ["",{"translate": "mgs.damage_debug","color":"white"},{"translate": "mgs.off","color":"red"},{"translate": "mgs.toggle", "color": "yellow", "click_event": {"action": "run_command", "command": "/trigger mgs.player.config set 3"}, "hover_event": {"action": "show_text", "value": "Toggle damage numbers in chat"}}]
tellraw @s {"text":"=======================================","color":"dark_gray"}
