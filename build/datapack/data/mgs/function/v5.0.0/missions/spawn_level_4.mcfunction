...
data modify storage mgs:temp _enemy_iter set from storage mgs:missions game.map.enemies.level_4

# Copy enemy config for this level
data modify storage mgs:temp _enemy_config set from storage mgs:missions game.map.enemy_config.level_4
