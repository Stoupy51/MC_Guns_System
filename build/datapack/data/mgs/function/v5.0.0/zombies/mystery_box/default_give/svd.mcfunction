...
#> mgs:v5.0.0/zombies/mystery_box/default_give/svd
#
# @within	???
#

data modify storage mgs:temp _wb_weapon set value {weapon_id:"svd",name:"svd",consumable:0b,magazine_id:"svd_mag",mag_count:3}
