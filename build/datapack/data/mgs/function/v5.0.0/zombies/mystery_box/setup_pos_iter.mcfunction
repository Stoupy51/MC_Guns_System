...
execute as @n[tag=mgs.mb_new] run function #bs.interaction:on_hover_enter {run:"function mgs:v5.0.0/zombies/mystery_box/on_hover_enter",executor:"source"}
execute as @n[tag=mgs.mb_new] run function #bs.interaction:on_hover_leave {run:"function mgs:v5.0.0/zombies/mystery_box/on_hover_leave",executor:"source"}
