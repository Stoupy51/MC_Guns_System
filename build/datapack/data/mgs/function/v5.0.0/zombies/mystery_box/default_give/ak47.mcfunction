...
#> mgs:v5.0.0/zombies/mystery_box/default_give/ak47
#
# @within	???
#

data modify storage mgs:temp _wb_weapon set value {weapon_id:"ak47",name:"ak47",consumable:0b,mag_id:"ak47_mag",mag_count:3}
