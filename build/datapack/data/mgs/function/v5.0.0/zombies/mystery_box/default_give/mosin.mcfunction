...
#> mgs:v5.0.0/zombies/mystery_box/default_give/mosin
#
# @within	???
#

data modify storage mgs:temp _wb_weapon set value {weapon_id:"mosin",name:"mosin",consumable:1b,mag_id:"mosin_bullet",mag_count:10}
