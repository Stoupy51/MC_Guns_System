...
#> mgs:v5.0.0/zombies/mystery_box/default_give/rpk
#
# @within	???
#

data modify storage mgs:temp _wb_weapon set value {weapon_id:"rpk",name:"rpk",consumable:0b,magazine_id:"rpk_mag",mag_count:3}
