...
function #bs.sidebar:create {objective:"mgs.zb_sidebar",display_name:{text:"🧟 Zombies",color:"dark_green",bold:true},contents:[{text:" Round: ",extra:[{score:{name:"#zb_round",objective:"mgs.data"},color:"gold"}],color:"red"},{translate: "mgs.zombies",extra:[{score:{name:"#_zb_total",objective:"mgs.data"},color:"red"}],color:"gray"}," "]}
