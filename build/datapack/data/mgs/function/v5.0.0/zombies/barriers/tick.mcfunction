...
execute if score @s mgs.zb.barrier.state matches 0 run function mgs:v5.0.0/zombies/barriers/intact_tick
...
execute rotated as @s as @a[scores={mgs.zb.in_game=1},distance=..0.75] positioned as @s run tp @s ^ ^ ^0.8
