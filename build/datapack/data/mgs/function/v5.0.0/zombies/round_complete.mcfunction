...
tellraw @a ["",{"text":"","color":"dark_green","bold":true},"🧟 ",{"text":"Round ","color":"green"},{"score":{"name":"#completed_round","objective":"mgs.data"},"color":"gold","bold":true},{"translate": "mgs.complete_500_points_next_round_in_10_seconds","color":"green"}]
