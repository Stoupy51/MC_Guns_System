...
$tellraw @s ["","  ",{"text":""},{"text":"[$(name)]","color":"green","click_event":{"action":"suggest_command","command":"/data modify storage mgs:zombies game.map_id set value \"$(id)\""},"hover_event":{"action":"show_text","value":"Click to select '$(name)'"}},{"text":" - $(description)","color":"gray"}]
