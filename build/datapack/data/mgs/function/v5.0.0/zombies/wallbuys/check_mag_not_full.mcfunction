...
$execute if items entity @s $(slot) *[custom_data~{mgs:{magazine:true}}] run summon minecraft:item_display run function mgs:v5.0.0/zombies/wallbuys/read_mag_state {slot:"$(slot)"}
