...
#
# @within	mgs:v5.0.0/zombies/wallbuys/process_purchase {hotbar:1,inventory:1,weapon_id:"$(weapon_id)",magazine_id:"$(magazine_id)"}
#			mgs:v5.0.0/zombies/wallbuys/process_purchase {hotbar:2,inventory:2,weapon_id:"$(weapon_id)",magazine_id:"$(magazine_id)"}
#			mgs:v5.0.0/zombies/wallbuys/process_purchase {hotbar:3,inventory:3,weapon_id:"$(weapon_id)",magazine_id:"$(magazine_id)"}
#
# @args		hotbar (int)
#			weapon_id (string)
#			inventory (int)
