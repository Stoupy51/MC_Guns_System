...
#> mgs:v5.0.0/zombies/wallbuys/give_to_slot
#
# @within	mgs:v5.0.0/zombies/wallbuys/process_purchase {hotbar:1,inventory:1,weapon_id:"$(weapon_id)"}
#			mgs:v5.0.0/zombies/wallbuys/process_purchase {hotbar:2,inventory:2,weapon_id:"$(weapon_id)"}
#			mgs:v5.0.0/zombies/wallbuys/process_purchase {hotbar:3,inventory:3,weapon_id:"$(weapon_id)"}
#
# @args		hotbar (int)
#			weapon_id (string)
#			inventory (int)
...
$execute store success score #wb_mag_given mgs.data run loot replace entity @s inventory.$(inventory) loot mgs:i/$(weapon_id)_mag
