...
data modify storage smithed.actionbar:input message set value {json:[[{"text":"🔫 ","color":"gold"}, {"translate":"mgs.wallbuy"}],[{"text":" - ","color":"gray"}, {"translate":"mgs.cost_2"}],{"score":{"name":"#wb_price","objective":"mgs.data"},"color":"yellow"},[{"text":" ","color":"gray"}, {"translate":"mgs.points_4"}]],priority:'notification',freeze:5}
