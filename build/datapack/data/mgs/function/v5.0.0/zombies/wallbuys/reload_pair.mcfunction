...
$execute if score #wb_new_mag mgs.data matches 1 store success score #wb_mag_created mgs.data run loot replace entity @s inventory.$(inventory) loot mgs:i/$(weapon_id)_mag
