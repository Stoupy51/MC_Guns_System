...
title @s title [{"text":"🔫 ","color":"gold"},{"storage":"mgs:temp","nbt":"_wb_hover_name","color":"gold"}]
title @s subtitle [{"translate": "mgs.cost","color":"gray"},{"score":{"name":"#wb_price","objective":"mgs.data"},"color":"yellow"},{"translate": "mgs.points","color":"gray"}]
