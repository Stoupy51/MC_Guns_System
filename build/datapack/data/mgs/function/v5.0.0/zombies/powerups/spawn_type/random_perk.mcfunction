...
#> mgs:v5.0.0/zombies/powerups/spawn_type/random_perk
#
# @executed	at @s
#
...
$summon minecraft:item_display $(x) $(y) $(z) {Tags:["mgs.pu_item","mgs.pu_item_new","mgs.gm_entity"],item:{id:"minecraft:glass_bottle",count:1,components:{"minecraft:item_model":"mgs:zombies/powerup/random_perk"}},item_display:"ground",billboard:"center",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.25f,0f],scale:[0.7f,0.7f,0.7f]}}
