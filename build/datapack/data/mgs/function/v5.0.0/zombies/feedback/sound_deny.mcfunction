...
#			mgs:v5.0.0/zombies/pap/deny_not_enough_points_scope
#			mgs:v5.0.0/zombies/pap/deny_no_scope_variants
#			mgs:v5.0.0/zombies/pap/anim/deny_processing
...
#			mgs:v5.0.0/zombies/wallbuys/deny_hold_valid_slot
