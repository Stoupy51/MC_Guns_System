...
execute if score #zb_power mgs.data matches 1 run return fail
...
execute as @e[tag=mgs.power_switch] at @s run playsound minecraft:entity.firework_rocket.twinkle_far master @a ~ ~ ~ 2 1
