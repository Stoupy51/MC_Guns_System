...
#> mgs:v5.0.0/shared/run_start_commands_iter
#
# @within	mgs:v5.0.0/shared/run_start_commands
#			mgs:v5.0.0/shared/run_start_commands_iter
#
...
# Execute and advance
function mgs:v5.0.0/shared/run_start_command with storage mgs:temp _start_cmd
