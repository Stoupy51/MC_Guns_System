...
execute positioned ~ ~-1 ~ run scoreboard players operation @n[type=!#bs.hitbox:intangible,distance=..2,tag=!mgs.grenade,tag=!mgs.slow_bullet] mgs.stuck_id = #semtex_id mgs.data
