...
execute at @e[tag=mgs.flash_source,limit=1] store result score #in_fov mgs.data run function #bs.view:in_view_ata {angle:110}
...
execute at @e[tag=mgs.flash_source,limit=1] store result score #can_see mgs.data run function #bs.view:can_see_ata {with:{}}
