...
execute if score #is_zoom stoupgun.data matches 0 store result score #offset_x stoupgun.data run data get storage stoupgun:gun all.stats.casing_offset.normal[0] 1000
execute if score #is_zoom stoupgun.data matches 0 store result score #offset_y stoupgun.data run data get storage stoupgun:gun all.stats.casing_offset.normal[1] 1000
execute if score #is_zoom stoupgun.data matches 0 store result score #offset_z stoupgun.data run data get storage stoupgun:gun all.stats.casing_offset.normal[2] 1000
execute if score #is_zoom stoupgun.data matches 1 store result score #offset_x stoupgun.data run data get storage stoupgun:gun all.stats.casing_offset.zoom[0] 1000
execute if score #is_zoom stoupgun.data matches 1 store result score #offset_y stoupgun.data run data get storage stoupgun:gun all.stats.casing_offset.zoom[1] 1000
execute if score #is_zoom stoupgun.data matches 1 store result score #offset_z stoupgun.data run data get storage stoupgun:gun all.stats.casing_offset.zoom[2] 1000
