...
execute store result score #casing_normal stoupgun.data run data get storage stoupgun:gun stats.casing_n
execute store result score #casing_tangent stoupgun.data run data get storage stoupgun:gun stats.casing_t
execute store result score #casing_binormal stoupgun.data run data get storage stoupgun:gun stats.casing_b

# Stop if no casing data
execute unless data storage stoupgun:gun stats.casing_model run return fail
...
data modify storage stoupgun:temp casing.Item.components."minecraft:item_model" set from storage stoupgun:gun stats.casing_model
