...
execute unless score #game_version stoupgun.data matches 4321.. run scoreboard players set #mcload_error stoupgun.data 1

# Decode errors
execute if score #mcload_error stoupgun.data matches 1 run tellraw @a {"translate":"stoupgun_error_this_version_is_made_for_minecraft_1_21_5","color":"red"}
