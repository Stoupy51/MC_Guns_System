...
For each task to do, type `rm done_with_current_task` command in terminal, a Review Agent will check on it and tell you if the task is good and you can continue on!
