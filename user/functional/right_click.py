...
def main(config: dict) -> None:
    ...
    write_versioned_function(config, "right_click/set_pending_clicks", f"""
# Revoke advancement
...
""")
    ...
    write_versioned_function(config, "player/tick", f"""
...
""")
    ...
    # Handle pending clicks
    write_versioned_function(config, "right_click/handle", f"""
...
""")
    ...
    # On hit point
    write_versioned_function(config, "raycast/on_hit_point", f"""
...
""")
    ...
    # On targeted block
    write_versioned_function(config, "raycast/on_targeted_block", f"""
particle happy_villager ~ ~ ~ 0 0 0 0 10
...
""")
    ...
    # On targeted entity
    write_versioned_function(config, "raycast/on_targeted_entity", f"""
particle happy_villager ~ ~ ~ 0 0 0 0 10
