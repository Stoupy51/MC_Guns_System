...
""")
    ...
    write_versioned_function(config, "switch/force_switch_animation",
f"""
...
""")  # noqa: E501
    ...
    write_versioned_function(config, "switch/sync_attack_speed_with_cooldown",
f"""
...
""")
    ...
    write_versioned_function(config, "switch/modify_attack_speed",
f"""
