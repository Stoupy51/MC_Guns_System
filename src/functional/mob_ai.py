...
execute if score #mob_has_target {ns}.data matches 0 store success score #mob_has_target {ns}.data run tag @p[distance=..64,gamemode=!spectator,gamemode=!creative] add {ns}.target
