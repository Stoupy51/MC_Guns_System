...
class AbilityGenerator(McfunctionGenerator):
    """ Generates the ability datapack functions. """
    ...
    def generate(self) -> None:
    	...
    	self.func("zombies/passive_ability_menu", f"""
...
""")
    	...
    	self.func("zombies/ability_menu", f"""
# Zonweeb variant only
execute unless data storage {ns}:zombies game{{variant:"zonweeb"}} run return fail
...
""")
    	...
    	self.func("zombies/perks/set_passive_1", f"""
# Zonweeb variant only
execute unless data storage {ns}:zombies game{{variant:"zonweeb"}} run return fail
...
""")
    	...
    	self.func("zombies/perks/set_passive_2", f"""
# Zonweeb variant only
execute unless data storage {ns}:zombies game{{variant:"zonweeb"}} run return fail
...
""")
    	...
    	self.func("zombies/perks/set_ability_1", f"""
# Zonweeb variant only
execute unless data storage {ns}:zombies game{{variant:"zonweeb"}} run return fail
...
""")
    	...
    	self.func("zombies/perks/set_ability_2", f"""
# Zonweeb variant only
execute unless data storage {ns}:zombies game{{variant:"zonweeb"}} run return fail
...
""")
    	...
    	self.func("zombies/ability_tick", f"""
...
""")
    	...
    	self.func("zombies/perks/check_coward", f"""
...
""")
    	...
    	self.func("zombies/perks/trigger_coward", f"""
...
""")
    	...
    	self.func("zombies/perks/check_guardian", f"""
...
""")
    	...
    	self.func("zombies/perks/trigger_guardian", f"""
...
""")
    	...
    	self.func("zombies/perks/reduce_cooldowns", f"""
...
def generate_zombies_abilities() -> None:
	""" Module-level entry (preserved signature); delegates to :class:`AbilityGenerator`. """
	AbilityGenerator()()
