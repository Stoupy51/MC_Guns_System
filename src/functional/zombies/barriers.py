...
class BarriersGenerator(McfunctionGenerator):
    """ Generates the barriers datapack functions. """
...
""")
    	...
    	self.func("zombies/barriers/setup", f"""
...
""")
    	...
    	self.func("zombies/barriers/setup_iter", f"""
...
""")
    	...
    	self.func("zombies/barriers/place_at", f"""
...
""")
    	...
    	self.func("zombies/barriers/tick", f"""
...
""")
    	...
    	## Intact barrier tick
    	self.func("zombies/barriers/intact_tick", f"""
...
""")
    	...
    	self.func("zombies/barriers/freeze_zombies", f"""
...
""")
    	...
    	self.func("zombies/barriers/find_remover", f"""
...
""")
    	...
    	self.func("zombies/barriers/start_removing_zombie", f"""
...
""")
    	...
    	self.func("zombies/barriers/handle_removing", f"""
# MACRO: @s = intact barrier marker, $(radius) = sphere radius
...
""")
    	...
    	self.func("zombies/barriers/on_remover_valid", f"""
...
""")
    	...
    	self.func("zombies/barriers/cancel_remove", f"""
...
""")
    	...
    	self.func("zombies/barriers/destroy", f"""
...
""")
    	...
    	self.func("zombies/barriers/destroyed_tick", f"""
...
""")
    	...
    	self.func("zombies/barriers/find_repairer", f"""
...
""")
    	...
    	self.func("zombies/barriers/start_repairing_player", f"""
...
""")
    	...
    	self.func("zombies/barriers/handle_repair", f"""
# MACRO: @s = destroyed barrier marker, $(radius) = sphere radius
...
""")
    	...
    	self.func("zombies/barriers/on_repairer_valid", f"""
# @s = repairing player
...
""")
    	...
    	self.func("zombies/barriers/cancel_repair", f"""
...
""")
    	...
    	self.func("zombies/barriers/repair", f"""
...
""")
    	...
    	self.func("zombies/barriers/on_repair_complete_player", f"""
# @s = repairing player
...
""")
    	...
    	self.func("zombies/barriers/restore_zombie_speed", f"""
...
""")
    	...
    	self.func("zombies/on_round_start", f"""
...
""")
    	...
    	self.func("zombies/barriers/repair_all", f"""
...
""")
    	...
    	self.func("zombies/barriers/instant_repair", f"""
...
def generate_barriers() -> None:
	""" Module-level entry (preserved signature); delegates to :class:`BarriersGenerator`. """
	BarriersGenerator()()
