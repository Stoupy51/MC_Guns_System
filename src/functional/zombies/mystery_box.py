...
class MysteryBoxGenerator(McfunctionGenerator):
    """ Generates the mysterybox datapack functions. """
...
""")
    	...
    	for weapon_id in default_pool_weapons:
    		...
    		self.func(f"zombies/mystery_box/default_give/{weapon_id}", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/ensure_default_pool", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/setup_positions", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/setup_pos_iter", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/summon_pos_at", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/sync_presence_display", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/summon_presence_display", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/on_right_click", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/box_click", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/fire_sale_start", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/fire_sale_summon_box", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/summon_temp_box", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/fire_sale_end", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/fire_sale_cleanup", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/try_use", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/pick_random_result", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/check_owned_result", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/check_ray_gun_cap", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/reroll_owned", f"""
scoreboard players set #mb_owned {ns}.data 0
...
""")
    	...
    	self.func("zombies/mystery_box/deny_not_enough_points", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/spawn_display", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/tick", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/spin_tick_one", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/cycle_step_one", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/cycle_display_one", f"""
data modify storage bs:in random.weighted_choice.options set from storage {ns}:zombies mystery_box_pool
data modify storage bs:in random.weighted_choice.weights set from storage {ns}:zombies mystery_box_weights
function #bs.random:weighted_choice
...
""")
    	...
    	self.func("zombies/mystery_box/cycle_display_weapon_one", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/show_result_one", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/pick_for_buyer", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/result_all_owned", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/show_result_weapon_one", f"""
$loot replace entity @s contents loot {ns}:i/$(weapon_id)
""")

    	## Teddy bear result: box is about to move (Black Ops style). @s = the active box's display.
    	self.func("zombies/mystery_box/show_bear_result", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/move_anim_tick", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/move_anim_start_ascend", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/move_anim_ascend_step", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/move_anim_transition", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/move_anim_descend_step", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/move_anim_land", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/collect", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/capture_collected_name", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/capture_collected_name_slot", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/extract_collected_item_name", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/hud_ready", """
...
""")
    	...
    	self.func("zombies/mystery_box/hud_spinning", """
...
""")
    	...
    	self.func("zombies/mystery_box/hud_price", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/hud_moving", """
...
""")
    	...
    	self.func("zombies/mystery_box/on_hover", f"""
...
""")
    	...
    	self.func("zombies/mystery_box/hover_at_box", f"""
...
def generate_mystery_box() -> None:
	""" Module-level entry (preserved signature); delegates to :class:`MysteryBoxGenerator`. """
	MysteryBoxGenerator()()
