...
from ....config.stats import ACCURACY_BASE, ACCURACY_JUMP, ACCURACY_SNEAK, ACCURACY_SPRINT, ACCURACY_WALK, BURST, COOLDOWN, DAMAGE, DECAY, FIRE_MODE, GRENADE_TYPE, PELLET_COUNT, PROJECTILE_SPEED
